...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon9.addPixmap(QtGui.QPixmap(":/icons/pause.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.inputs_variable_play.setIcon(icon9)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/icons/interrupted.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.inputs_variable_stop.setIcon(icon10)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/icons/record.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.inputs_record_record.setIcon(icon11)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/icons/motor.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.Panel.addTab(self.inputs_tab, icon12, "")
        ...
        self.Panel.addTab(self.synthesis_tab, icon13, "")
        ...
        self.Panel.addTab(self.history_tab, icon14, "")
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/icons/git.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.Panel.addTab(self.version_control_tab, icon15, "")
        ...
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(":/icons/settings.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.Panel.addTab(self.settings_tab, icon16, "")
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(":/icons/BrowseAim.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(":/icons/freemove_off.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.FreeMoveMode.setIcon(icon18)
        ...
        self.disconnectConsoleButton.setIcon(icon19)
        ...
        self.connectConsoleButton.setIcon(icon20)
        ...
        icon25 = QtGui.QIcon()
        icon25.addPixmap(QtGui.QPixmap(":/icons/main.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_About_Pyslvs.setIcon(icon25)
        ...
        self.action_Output_to_DXF.setIcon(icon29)
        ...
        self.action_Import_Workbook.setIcon(icon32)
        ...
        self.action_Import_PMKS_server.setIcon(icon35)
        ...
        self.action_Import_Expression.setIcon(icon25)
        ...
        self.action_Output_to_Expression.setIcon(icon25)
        ...
        self.action_Save_branch.setIcon(icon15)
        ...
        self.action_Import_Example.setIcon(icon36)
        ...
        self.action_Output_to_Picture_clipboard.setIcon(icon27)
