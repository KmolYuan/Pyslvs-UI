...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.LinkTabWidget = QtWidgets.QWidget(self.ToolPanelSplitter)
        ...
        self.ToolPanelSplitterLine = QtWidgets.QFrame(self.LinkTabWidget)
        self.ToolPanelSplitterLine.setLineWidth(3)
        self.ToolPanelSplitterLine.setFrameShape(QtWidgets.QFrame.HLine)
        self.ToolPanelSplitterLine.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.ToolPanelSplitterLine.setObjectName("ToolPanelSplitterLine")
        self.verticalLayout_30.addWidget(self.ToolPanelSplitterLine)
        ...
        self.Entiteis_Link_Widget = QtWidgets.QWidget(self.LinksTab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icons/tools.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.OutputToPMKS = QtWidgets.QPushButton(self.BrowserWidget)
        self.OutputToPMKS.setText("")
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/icons/PMKSLogo.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.OutputToPMKS.setIcon(icon14)
        self.OutputToPMKS.setIconSize(QtCore.QSize(32, 32))
        self.OutputToPMKS.setObjectName("OutputToPMKS")
        self.horizontalLayout_7.addWidget(self.OutputToPMKS)
        ...
        icon32 = QtGui.QIcon()
        icon32.addPixmap(QtGui.QPixmap(":/icons/loadfile.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_Import_From_Workbook.setIcon(icon32)
        ...
        icon33 = QtGui.QIcon()
        icon33.addPixmap(QtGui.QPixmap(":/icons/Logo_Qt.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_About_Qt.setIcon(icon33)
        ...
        self.action_Load_Workbook.setIcon(icon32)
        ...
        icon34 = QtGui.QIcon()
        icon34.addPixmap(QtGui.QPixmap(":/icons/PathTrack.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_Path_Track.setIcon(icon34)
        ...
        icon35 = QtGui.QIcon()
        icon35.addPixmap(QtGui.QPixmap(":/icons/data.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_Path_coordinate.setIcon(icon35)
        ...
        self.action_Output_to_PMKS.setIcon(icon14)
