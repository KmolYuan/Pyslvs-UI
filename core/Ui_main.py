...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.mechanism_list = QtWidgets.QListWidget(self.MechanismsTabWidget)
        self.mechanism_list.setObjectName("mechanism_list")
        item = QtWidgets.QListWidgetItem()
        self.mechanism_list.addItem(item)
        self.verticalLayout_30.addWidget(self.mechanism_list)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_6.setText(_translate("MainWindow", "Mechanism list:"))
        __sortingEnabled = self.mechanism_list.isSortingEnabled()
        self.mechanism_list.setSortingEnabled(False)
        item = self.mechanism_list.item(0)
        item.setText(_translate("MainWindow", "Main"))
        self.mechanism_list.setSortingEnabled(__sortingEnabled)
