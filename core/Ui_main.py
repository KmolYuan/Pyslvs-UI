...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.action_See_Python_Scripts.setEnabled(False)
        icon28 = QtGui.QIcon()
        ...
        self.action_Example.setEnabled(False)
        icon36 = QtGui.QIcon()
        icon36.addPixmap(QtGui.QPixmap(":/icons/example.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_Example.setIcon(icon36)
