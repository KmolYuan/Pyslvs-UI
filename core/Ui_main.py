...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(":/icons/freemove_off.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon17.addPixmap(QtGui.QPixmap(":/icons/freemove_on.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.FreeMoveMode.setIcon(icon17)
        ...
        icon38 = QtGui.QIcon()
        icon38.addPixmap(QtGui.QPixmap(":/icons/PMKSLogo.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_Output_to_PMKS.setIcon(icon38)
        self.action_Output_to_PMKS.setObjectName("action_Output_to_PMKS")
        self.action_From_PMKS_server = QtWidgets.QAction(MainWindow)
        self.action_From_PMKS_server.setIcon(icon38)
