...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Inputs = QtWidgets.QPushButton(self.groupBox_3)
        self.Inputs.setText("")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icons/motor.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.Inputs.setIcon(icon4)
        self.Inputs.setIconSize(QtCore.QSize(40, 40))
        self.Inputs.setCheckable(True)
        self.Inputs.setObjectName("Inputs")
        self.gridLayout.addWidget(self.Inputs, 1, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Inputs.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Inputs</span></p><p>Set inputs of this mechanism by the degree of freedom.<br/><img src=\":/icons/tooltips/DriveShaft.png\"/></p></body></html>"))
        self.Inputs.setStatusTip(_translate("MainWindow", "Drive the selected drive shaft."))
