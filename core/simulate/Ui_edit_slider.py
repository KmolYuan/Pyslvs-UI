...
# Form implementation generated from reading ui file '/home/ahshoe/桌面/Pyslvs-PyQt5/core/simulate/edit_slider.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(406, 275)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(Dialog.sizePolicy().hasHeightForWidth())
        Dialog.setSizePolicy(sizePolicy)
        Dialog.setMinimumSize(QtCore.QSize(406, 275))
        Dialog.setMaximumSize(QtCore.QSize(406, 275))
        icon = QtGui.QIcon()
