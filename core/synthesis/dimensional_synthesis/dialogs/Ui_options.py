...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        icon = QIcon()
        icon.addPixmap(QPixmap(":/icons/synthesis.png"), QIcon.Normal, QIcon.Off)
        ...
        self.max_gen_option = QRadioButton(Dialog)
        self.max_gen_option.setChecked(True)
        self.max_gen_option.setObjectName("max_gen_option")
        self.formLayout.setWidget(2, QFormLayout.LabelRole, self.max_gen_option)
        self.max_gen = QSpinBox(Dialog)
        ...
        self.formLayout.setWidget(2, QFormLayout.FieldRole, self.max_gen)
        self.min_fit_option = QRadioButton(Dialog)
        self.min_fit_option.setObjectName("min_fit_option")
        self.formLayout.setWidget(3, QFormLayout.LabelRole, self.min_fit_option)
        self.min_fit = QDoubleSpinBox(Dialog)
        ...
        self.formLayout.setWidget(3, QFormLayout.FieldRole, self.min_fit)
        self.report_label = QLabel(Dialog)
        self.report_label.setObjectName("report_label")
        self.formLayout.setWidget(5, QFormLayout.LabelRole, self.report_label)
        self.report = QSpinBox(Dialog)
        self.report.setProperty("value", 10)
        self.report.setObjectName("report")
        self.formLayout.setWidget(5, QFormLayout.FieldRole, self.report)
        self.max_time_option = QRadioButton(Dialog)
        self.max_time_option.setObjectName("max_time_option")
        self.formLayout.setWidget(4, QFormLayout.LabelRole, self.max_time_option)
        self.max_time = QWidget(Dialog)
        self.max_time.setEnabled(False)
        self.max_time.setObjectName("max_time")
        self.horizontalLayout_2 = QHBoxLayout(self.max_time)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.max_time_h = QSpinBox(self.max_time)
        self.max_time_h.setObjectName("max_time_h")
        self.horizontalLayout_2.addWidget(self.max_time_h)
        self.label_2 = QLabel(self.max_time)
        ...
        self.max_time_m = QSpinBox(self.max_time)
        ...
        self.label_3 = QLabel(self.max_time)
        sizePolicy = QSizePolicy(QSizePolicy.Fixed, QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.max_time_s = QSpinBox(self.max_time)
        ...
        self.formLayout.setWidget(4, QFormLayout.FieldRole, self.max_time)
        self.label = QLabel(Dialog)
        self.label.setObjectName("label")
        self.formLayout.setWidget(1, QFormLayout.LabelRole, self.label)
        self.pop_size = QSpinBox(Dialog)
        ...
        self.formLayout.setWidget(1, QFormLayout.FieldRole, self.pop_size)
        ...
        self.alg_table = QTableWidget(self.splitter)
