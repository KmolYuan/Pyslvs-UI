...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        icon = QIcon()
        icon.addPixmap(QPixmap(":/icons/DimensionalSynthesis.png"), QIcon.Normal, QIcon.Off)
        ...
        self.path_list = QListWidget(self.layoutWidget)
        ...
        self.verticalLayout_2 = QVBoxLayout(self.moving)
        self.verticalLayout_2.setContentsMargins(6, 6, 6, 6)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.gridLayout = QGridLayout()
        self.gridLayout.setObjectName("gridLayout")
        self.label = QLabel(self.moving)
        self.label.setObjectName("label")
        self.gridLayout.addWidget(self.label, 0, 0, 1, 1)
        spacerItem = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)
        self.gridLayout.addItem(spacerItem, 0, 2, 1, 1)
        self.label_2 = QLabel(self.moving)
        self.label_2.setObjectName("label_2")
        self.gridLayout.addWidget(self.label_2, 1, 0, 1, 1)
        self.moving_y_coordinate = QDoubleSpinBox(self.moving)
        ...
        self.moving_x_coordinate = QDoubleSpinBox(self.moving)
        ...
        spacerItem2 = QSpacerItem(20, 99, QSizePolicy.Minimum, QSizePolicy.Expanding)
        self.verticalLayout_2.addItem(spacerItem2)
        self.horizontalLayout_3 = QHBoxLayout()
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        spacerItem3 = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)
        self.horizontalLayout_3.addItem(spacerItem3)
        self.moving_button = QPushButton(self.moving)
        ...
        self.scaling = QWidget()
        self.scaling.setObjectName("scaling")
        self.verticalLayout_3 = QVBoxLayout(self.scaling)
        ...
        self.scaling_h = QDoubleSpinBox(self.scaling)
        ...
        self.label_3 = QLabel(self.scaling)
        self.label_3.setObjectName("label_3")
        self.gridLayout_2.addWidget(self.label_3, 0, 0, 1, 1)
        self.label_4 = QLabel(self.scaling)
        ...
        self.scaling_v = QDoubleSpinBox(self.scaling)
        ...
        self.label_5 = QLabel(self.scaling)
        self.label_5.setObjectName("label_5")
        self.horizontalLayout_2.addWidget(self.label_5)
        self.scaling_rx = QDoubleSpinBox(self.scaling)
        ...
        self.scaling_ry = QDoubleSpinBox(self.scaling)
        ...
        spacerItem8 = QSpacerItem(20, 52, QSizePolicy.Minimum, QSizePolicy.Expanding)
        self.verticalLayout_3.addItem(spacerItem8)
        self.horizontalLayout_4 = QHBoxLayout()
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        spacerItem9 = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)
        self.horizontalLayout_4.addItem(spacerItem9)
        self.scaling_button = QPushButton(self.scaling)
        ...
        self.curve_fitting = QWidget()
        self.curve_fitting.setObjectName("curve_fitting")
        self.verticalLayout_4 = QVBoxLayout(self.curve_fitting)
        self.verticalLayout_4.setContentsMargins(6, 6, 6, 6)
        self.verticalLayout_4.setObjectName("verticalLayout_4")
        self.label_8 = QLabel(self.curve_fitting)
        self.label_8.setWordWrap(True)
        self.label_8.setObjectName("label_8")
        self.verticalLayout_4.addWidget(self.label_8)
        self.horizontalLayout_7 = QHBoxLayout()
        self.horizontalLayout_7.setObjectName("horizontalLayout_7")
        self.label_7 = QLabel(self.curve_fitting)
        self.label_7.setObjectName("label_7")
        self.horizontalLayout_7.addWidget(self.label_7)
        self.points_num = QLabel(self.curve_fitting)
        ...
        self.label_6 = QLabel(self.curve_fitting)
        self.label_6.setObjectName("label_6")
        self.horizontalLayout_6.addWidget(self.label_6)
        self.match_num = QSpinBox(self.curve_fitting)
        ...
        self.match_button = QPushButton(self.curve_fitting)
