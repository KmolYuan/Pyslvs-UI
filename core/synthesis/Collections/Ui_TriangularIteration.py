...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/savefile.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.verticalLayout_10.addWidget(self.Expression_list_label)
        ...
        self.Expression_clear.setIcon(icon4)
        self.Expression_clear.setObjectName("Expression_clear")
        self.verticalLayout_10.addWidget(self.Expression_clear)
    ...
    def retranslateUi(self, Form):
        ...
        self.Expression_clear.setText(_translate("Form", "Clear"))
