...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.verticalLayout.addWidget(self.sorting_add)
        self.Loops_add = QtWidgets.QPushButton(Dialog)
        self.Loops_add.setMaximumSize(QtCore.QSize(30, 16777215))
        self.Loops_add.setObjectName("Loops_add")
        self.verticalLayout.addWidget(self.Loops_add)
        ...
        self.sorting_add_2 = QtWidgets.QPushButton(Dialog)
        self.sorting_add_2.setMaximumSize(QtCore.QSize(30, 16777215))
        self.sorting_add_2.setObjectName("sorting_add_2")
        self.verticalLayout_2.addWidget(self.sorting_add_2)
