...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.symmetric_button = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.symmetric_button.setEnabled(False)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icons/reflect.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.symmetric_button.setIcon(icon8)
        self.symmetric_button.setObjectName("symmetric_button")
        self.verticalLayout_4.addWidget(self.symmetric_button)
    ...
    def retranslateUi(self, Form):
        ...
        self.symmetric_button.setText(_translate("Form", "Make Symmetric"))
