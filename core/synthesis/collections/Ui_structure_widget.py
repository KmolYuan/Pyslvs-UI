...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/clean.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icons/save_file.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.expr_edges = QtWidgets.QLineEdit(self.widget)
        self.expr_edges.setReadOnly(True)
        self.expr_edges.setObjectName("expr_edges")
        self.horizontalLayout_3.addWidget(self.expr_edges)
        self.expr_copy = QtWidgets.QPushButton(self.widget)
        icon7 = QtGui.QIcon()
        ...
        self.grounded_button.setIcon(icon6)
