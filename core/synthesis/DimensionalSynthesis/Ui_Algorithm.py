...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.FourBar.setToolTip(_translate("Form", "<html><head/><body><h1>Four Bar</h1><p><img src=\":/icons/preview/4Bar_triangle.png\"/></p></body></html>"))
        self.FourBar.setText(_translate("Form", "Four Bar (?)"))
        self.EightBar.setToolTip(_translate("Form", "<html><head/><body><h1>Eight Bar</h1><p><img src=\":/icons/preview/8Bar_triangle.png\"/></p></body></html>"))
