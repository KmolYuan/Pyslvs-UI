...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.radioButton = QtWidgets.QRadioButton(self.planarlinkage)
        ...
        self.radioButton_2 = QtWidgets.QRadioButton(self.planarlinkage)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.radioButton.setToolTip(_translate("Dialog", "<html><head/><body><p>This parameter determines the generations of evolution.</p><p>If the value set to 0, algorithm will stop only when you clicked the interrupt button.</p></body></html>"))
        self.radioButton.setText(_translate("Dialog", "Max generation: (?)"))
        self.radioButton_2.setToolTip(_translate("Dialog", "<html><head/><body><p>This parameter determines the last fitness of evolution.</p><p>If the value set to 0, algorithm will stop only when you clicked the interrupt button.</p></body></html>"))
        self.radioButton_2.setText(_translate("Dialog", "Minimum fitness value: (?)"))
