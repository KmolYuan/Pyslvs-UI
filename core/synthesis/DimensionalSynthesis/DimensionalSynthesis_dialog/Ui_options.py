...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.minFit.setProperty("value", 10.0)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.report_label)
        self.report = QtWidgets.QSpinBox(self.planarlinkage)
        self.report.setProperty("value", 10)
        self.report.setObjectName("report")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.report)
