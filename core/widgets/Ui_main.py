...
"}")
        ...
        self.main_panel.addTab(self.project_tab, icon, "")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 601, 1177))
        ...
        self.main_panel.addTab(self.settings_tab, icon13, "")
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/icons/free_move_off.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.free_move_button.setIcon(icon15)
        ...
        self.console_disconnect_button.setIcon(icon16)
        ...
        self.console_connect_button.setIcon(icon17)
        ...
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(":/icons/clean.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.clearConsole.setIcon(icon18)
        ...
        self.menu_bar.setGeometry(QtCore.QRect(0, 0, 882, 41))
        ...
        icon19 = QtGui.QIcon()
        icon19.addPixmap(QtGui.QPixmap(":/icons/new_file.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.action_mde_tw.setIcon(icon21)
        ...
        self.action_export_image.setIcon(icon24)
        ...
        self.action_python_script.setIcon(icon25)
        ...
        self.action_export_dxf.setIcon(icon26)
        ...
        self.action_export_slvs.setIcon(icon27)
        ...
        icon31 = QtGui.QIcon()
        icon31.addPixmap(QtGui.QPixmap(":/icons/pmks.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_export_pmks_url.setIcon(icon31)
        self.action_export_pmks_url.setObjectName("action_export_pmks_url")
        self.action_import_pmks_url = QtWidgets.QAction(MainWindow)
        self.action_import_pmks_url.setIcon(icon31)
        ...
        self.action_exprsion.setIcon(icon25)
        ...
        self.action_export_image_clipboard.setIcon(icon24)
        ...
        icon33 = QtGui.QIcon()
        icon33.addPixmap(QtGui.QPixmap(":/icons/new_window.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_new_window.setIcon(icon33)
        ...
        icon34 = QtGui.QIcon()
        icon34.addPixmap(QtGui.QPixmap(":/icons/yaml.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon35 = QtGui.QIcon()
        icon35.addPixmap(QtGui.QPixmap(":/icons/collections.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_documentation.setIcon(icon35)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_export_slvs.setText(_translate("MainWindow", "S&olvespace Parts"))
