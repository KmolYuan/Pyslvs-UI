...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addPixmap(QPixmap(":/icons/main_big.png"), QIcon.Normal, QIcon.Off)
        ...
        self.left_splitter = QSplitter(self.main_splitter)
        self.left_splitter.setMinimumSize(QSize(450, 0))
        self.left_splitter.setOrientation(Qt.Vertical)
        self.left_splitter.setObjectName("left_splitter")
        self.curve_area = QWidget(self.left_splitter)
        self.curve_area.setObjectName("curve_area")
        self.verticalLayout_31 = QVBoxLayout(self.curve_area)
        self.verticalLayout_31.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_31.setObjectName("verticalLayout_31")
        self.main_panel = QTabWidget(self.curve_area)
        self.main_panel.setTabPosition(QTabWidget.West)
        self.main_panel.setObjectName("main_panel")
        self.mechanism_tab = QWidget()
        self.mechanism_tab.setObjectName("mechanism_tab")
        self.verticalLayout_27 = QVBoxLayout(self.mechanism_tab)
        self.verticalLayout_27.setContentsMargins(3, 3, 3, 3)
        self.verticalLayout_27.setObjectName("verticalLayout_27")
        self.mechanism_panel_splitter = QSplitter(self.mechanism_tab)
        self.mechanism_panel_splitter.setOrientation(Qt.Vertical)
        self.mechanism_panel_splitter.setObjectName("mechanism_panel_splitter")
        self.EntitiesTabWidget = QWidget(self.mechanism_panel_splitter)
        self.EntitiesTabWidget.setObjectName("EntitiesTabWidget")
        self.verticalLayout_29 = QVBoxLayout(self.EntitiesTabWidget)
        self.verticalLayout_29.setContentsMargins(3, 3, 3, 3)
        self.verticalLayout_29.setObjectName("verticalLayout_29")
        self.entities_tab = QTabWidget(self.EntitiesTabWidget)
        self.entities_tab.setObjectName("entities_tab")
        self.PointsTab = QWidget()
        self.PointsTab.setObjectName("PointsTab")
        self.verticalLayout_9 = QVBoxLayout(self.PointsTab)
        self.verticalLayout_9.setContentsMargins(6, 6, 6, 6)
        self.verticalLayout_9.setObjectName("verticalLayout_9")
        self.entities_point_widget = QWidget(self.PointsTab)
        self.entities_point_widget.setContextMenuPolicy(Qt.CustomContextMenu)
        self.entities_point_widget.setObjectName("entities_point_widget")
        self.entities_point_layout = QVBoxLayout(self.entities_point_widget)
        ...
        icon1 = QIcon()
        icon1.addPixmap(QPixmap(":/icons/bearing.png"), QIcon.Normal, QIcon.Off)
        self.entities_tab.addTab(self.PointsTab, icon1, "")
        self.LinksTab = QWidget()
        self.LinksTab.setObjectName("LinksTab")
        self.verticalLayout_19 = QVBoxLayout(self.LinksTab)
        self.verticalLayout_19.setContentsMargins(6, 6, 6, 6)
        self.verticalLayout_19.setObjectName("verticalLayout_19")
        self.entities_link_widget = QWidget(self.LinksTab)
        self.entities_link_widget.setContextMenuPolicy(Qt.CustomContextMenu)
        self.entities_link_widget.setObjectName("entities_link_widget")
        self.entities_link_layout = QVBoxLayout(self.entities_link_widget)
        ...
        icon2 = QIcon()
        icon2.addPixmap(QPixmap(":/icons/link.png"), QIcon.Normal, QIcon.Off)
        self.entities_tab.addTab(self.LinksTab, icon2, "")
        self.tab = QWidget()
        self.tab.setObjectName("tab")
        self.verticalLayout_8 = QVBoxLayout(self.tab)
        self.verticalLayout_8.setObjectName("verticalLayout_8")
        self.EntitiesExpr_widget = QWidget(self.tab)
        self.EntitiesExpr_widget.setContextMenuPolicy(Qt.CustomContextMenu)
        self.EntitiesExpr_widget.setObjectName("EntitiesExpr_widget")
        self.entities_expr_layout = QVBoxLayout(self.EntitiesExpr_widget)
        ...
        self.link_free_move_base = QComboBox(self.EntitiesExpr_widget)
        self.link_free_move_base.setObjectName("link_free_move_base")
        self.horizontalLayout_4.addWidget(self.link_free_move_base)
        self.link_free_move_other = QComboBox(self.EntitiesExpr_widget)
        self.link_free_move_other.setObjectName("link_free_move_other")
        self.horizontalLayout_4.addWidget(self.link_free_move_other)
        spacerItem = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)
        self.horizontalLayout_4.addItem(spacerItem)
        self.link_free_move_spinbox = QDoubleSpinBox(self.EntitiesExpr_widget)
        self.link_free_move_spinbox.setMaximum(10000.0)
        self.link_free_move_spinbox.setObjectName("link_free_move_spinbox")
        self.horizontalLayout_4.addWidget(self.link_free_move_spinbox)
        self.link_free_move_reset = QPushButton(self.EntitiesExpr_widget)
        icon3 = QIcon()
        icon3.addPixmap(QPixmap(":/icons/clean.png"), QIcon.Normal, QIcon.Off)
        self.link_free_move_reset.setIcon(icon3)
        self.link_free_move_reset.setObjectName("link_free_move_reset")
        self.horizontalLayout_4.addWidget(self.link_free_move_reset)
        self.link_free_move_confirm = QPushButton(self.EntitiesExpr_widget)
        icon4 = QIcon()
        icon4.addPixmap(QPixmap(":/icons/merge.png"), QIcon.Normal, QIcon.Off)
        self.link_free_move_confirm.setIcon(icon4)
        self.link_free_move_confirm.setObjectName("link_free_move_confirm")
        self.horizontalLayout_4.addWidget(self.link_free_move_confirm)
        self.entities_expr_layout.addLayout(self.horizontalLayout_4)
        self.verticalLayout_8.addWidget(self.EntitiesExpr_widget)
        icon5 = QIcon()
        icon5.addPixmap(QPixmap(":/icons/configure.png"), QIcon.Normal, QIcon.Off)
        self.entities_tab.addTab(self.tab, icon5, "")
        self.verticalLayout_29.addWidget(self.entities_tab)
        self.MechanismsTabWidget = QWidget(self.mechanism_panel_splitter)
        self.MechanismsTabWidget.setObjectName("MechanismsTabWidget")
        self.verticalLayout_21 = QVBoxLayout(self.MechanismsTabWidget)
        self.verticalLayout_21.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_21.setObjectName("verticalLayout_21")
        self.MechanismPanelSplitterLine = QFrame(self.MechanismsTabWidget)
        self.MechanismPanelSplitterLine.setLineWidth(3)
        self.MechanismPanelSplitterLine.setFrameShape(QFrame.HLine)
        self.MechanismPanelSplitterLine.setFrameShadow(QFrame.Sunken)
        ...
        self.mechanism_storage_name_tag_text = QLabel(self.MechanismsTabWidget)
        ...
        self.mechanism_storage_name_tag = QLineEdit(self.MechanismsTabWidget)
        ...
        self.mechanism_storage = QListWidget(self.MechanismsTabWidget)
        ...
        self.mechanism_storage_add = QPushButton(self.MechanismsTabWidget)
        icon6 = QIcon()
        icon6.addPixmap(QPixmap(":/icons/data.png"), QIcon.Normal, QIcon.Off)
        self.mechanism_storage_add.setIcon(icon6)
        ...
        self.mechanism_storage_restore = QPushButton(self.MechanismsTabWidget)
        icon7 = QIcon()
        icon7.addPixmap(QPixmap(":/icons/data_update.png"), QIcon.Normal, QIcon.Off)
        self.mechanism_storage_restore.setIcon(icon7)
        ...
        self.line_4 = QFrame(self.MechanismsTabWidget)
        self.line_4.setFrameShape(QFrame.HLine)
        self.line_4.setFrameShadow(QFrame.Sunken)
        self.line_4.setObjectName("line_4")
        self.verticalLayout_20.addWidget(self.line_4)
        self.mechanism_storage_copy = QPushButton(self.MechanismsTabWidget)
        icon8 = QIcon()
        icon8.addPixmap(QPixmap(":/icons/copy.png"), QIcon.Normal, QIcon.Off)
        self.mechanism_storage_copy.setIcon(icon8)
        ...
        self.mechanism_storage_paste = QPushButton(self.MechanismsTabWidget)
        icon9 = QIcon()
        icon9.addPixmap(QPixmap(":/icons/paste.png"), QIcon.Normal, QIcon.Off)
        self.mechanism_storage_paste.setIcon(icon9)
        ...
        self.mechanism_storage_delete = QPushButton(self.MechanismsTabWidget)
        icon10 = QIcon()
        icon10.addPixmap(QPixmap(":/icons/delete.png"), QIcon.Normal, QIcon.Off)
        self.mechanism_storage_delete.setIcon(icon10)
        ...
        icon11 = QIcon()
        icon11.addPixmap(QPixmap(":/icons/mechanism.png"), QIcon.Normal, QIcon.Off)
        self.main_panel.addTab(self.mechanism_tab, icon11, "")
        self.inputs_tab = QWidget()
        self.inputs_tab.setObjectName("inputs_tab")
        self.inputs_tab_layout = QVBoxLayout(self.inputs_tab)
        self.inputs_tab_layout.setObjectName("inputs_tab_layout")
        icon12 = QIcon()
        icon12.addPixmap(QPixmap(":/icons/motor.png"), QIcon.Normal, QIcon.Off)
        self.main_panel.addTab(self.inputs_tab, icon12, "")
        self.synthesis_tab = QWidget()
        self.synthesis_tab.setObjectName("synthesis_tab")
        self.verticalLayout_14 = QVBoxLayout(self.synthesis_tab)
        self.verticalLayout_14.setContentsMargins(3, 3, 3, 3)
        self.verticalLayout_14.setObjectName("verticalLayout_14")
        self.synthesis_splitter = QSplitter(self.synthesis_tab)
        self.synthesis_splitter.setOrientation(Qt.Vertical)
        self.synthesis_splitter.setObjectName("synthesis_splitter")
        self.synthesis_tab_widget = QTabWidget(self.synthesis_splitter)
        self.synthesis_tab_widget.setObjectName("synthesis_tab_widget")
        self.verticalLayout_14.addWidget(self.synthesis_splitter)
        icon13 = QIcon()
        icon13.addPixmap(QPixmap(":/icons/synthesis.png"), QIcon.Normal, QIcon.Off)
        self.main_panel.addTab(self.synthesis_tab, icon13, "")
        self.history_tab = QWidget()
        self.history_tab.setObjectName("history_tab")
        self.verticalLayout = QVBoxLayout(self.history_tab)
        self.verticalLayout.setObjectName("verticalLayout")
        self.undo_redo_layout = QVBoxLayout()
        self.undo_redo_layout.setObjectName("undo_redo_layout")
        self.label_8 = QLabel(self.history_tab)
        ...
        icon14 = QIcon()
        icon14.addPixmap(QPixmap(":/icons/history.png"), QIcon.Normal, QIcon.Off)
        self.main_panel.addTab(self.history_tab, icon14, "")
        self.version_control_tab = QWidget()
        self.version_control_tab.setObjectName("version_control_tab")
        self.verticalLayout_5 = QVBoxLayout(self.version_control_tab)
        self.verticalLayout_5.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_5.setObjectName("verticalLayout_5")
        self.vc_layout = QVBoxLayout()
        self.vc_layout.setObjectName("vc_layout")
        self.verticalLayout_5.addLayout(self.vc_layout)
        icon15 = QIcon()
        icon15.addPixmap(QPixmap(":/icons/git.png"), QIcon.Normal, QIcon.Off)
        self.main_panel.addTab(self.version_control_tab, icon15, "")
        self.settings_tab = QWidget()
        self.settings_tab.setObjectName("settings_tab")
        self.verticalLayout_6 = QVBoxLayout(self.settings_tab)
        self.verticalLayout_6.setObjectName("verticalLayout_6")
        self.settings_scrollarea = QScrollArea(self.settings_tab)
        self.settings_scrollarea.setWidgetResizable(True)
        self.settings_scrollarea.setObjectName("settings_scrollarea")
        self.scrollAreaWidgetContents = QWidget()
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 561, 1042))
        self.scrollAreaWidgetContents.setObjectName("scrollAreaWidgetContents")
        self.verticalLayout_3 = QVBoxLayout(self.scrollAreaWidgetContents)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.settings_ui_groupbox = QGroupBox(self.scrollAreaWidgetContents)
        self.settings_ui_groupbox.setObjectName("settings_ui_groupbox")
        self.formLayout = QFormLayout(self.settings_ui_groupbox)
        self.formLayout.setObjectName("formLayout")
        self.linewidth_label = QLabel(self.settings_ui_groupbox)
        self.linewidth_label.setObjectName("linewidth_label")
        self.formLayout.setWidget(0, QFormLayout.LabelRole, self.linewidth_label)
        self.line_width_option = QSpinBox(self.settings_ui_groupbox)
        ...
        self.formLayout.setWidget(0, QFormLayout.FieldRole, self.line_width_option)
        self.fontsize_label = QLabel(self.settings_ui_groupbox)
        self.fontsize_label.setObjectName("fontsize_label")
        self.formLayout.setWidget(1, QFormLayout.LabelRole, self.fontsize_label)
        self.font_size_option = QSpinBox(self.settings_ui_groupbox)
        ...
        self.formLayout.setWidget(1, QFormLayout.FieldRole, self.font_size_option)
        self.pathwidth_label = QLabel(self.settings_ui_groupbox)
        self.pathwidth_label.setObjectName("pathwidth_label")
        self.formLayout.setWidget(3, QFormLayout.LabelRole, self.pathwidth_label)
        self.path_width_option = QSpinBox(self.settings_ui_groupbox)
        ...
        self.formLayout.setWidget(3, QFormLayout.FieldRole, self.path_width_option)
        self.scalefactor_label = QLabel(self.settings_ui_groupbox)
        self.scalefactor_label.setObjectName("scalefactor_label")
        self.formLayout.setWidget(4, QFormLayout.LabelRole, self.scalefactor_label)
        self.scalefactor_option = QSpinBox(self.settings_ui_groupbox)
        ...
        self.formLayout.setWidget(4, QFormLayout.FieldRole, self.scalefactor_option)
        self.selectionradius_label = QLabel(self.settings_ui_groupbox)
        self.selectionradius_label.setObjectName("selectionradius_label")
        self.formLayout.setWidget(5, QFormLayout.LabelRole, self.selectionradius_label)
        self.selection_radius_option = QSpinBox(self.settings_ui_groupbox)
        ...
        self.formLayout.setWidget(5, QFormLayout.FieldRole, self.selection_radius_option)
        self.linktransparency_label = QLabel(self.settings_ui_groupbox)
        self.linktransparency_label.setObjectName("linktransparency_label")
        self.formLayout.setWidget(6, QFormLayout.LabelRole, self.linktransparency_label)
        self.link_trans_option = QSpinBox(self.settings_ui_groupbox)
        ...
        self.formLayout.setWidget(6, QFormLayout.FieldRole, self.link_trans_option)
        self.marginfactor_label = QLabel(self.settings_ui_groupbox)
        self.marginfactor_label.setObjectName("marginfactor_label")
        self.formLayout.setWidget(7, QFormLayout.LabelRole, self.marginfactor_label)
        self.margin_factor_option = QSpinBox(self.settings_ui_groupbox)
        ...
        self.formLayout.setWidget(7, QFormLayout.FieldRole, self.margin_factor_option)
        self.jointsize_label = QLabel(self.settings_ui_groupbox)
        self.jointsize_label.setObjectName("jointsize_label")
        self.formLayout.setWidget(8, QFormLayout.LabelRole, self.jointsize_label)
        self.joint_size_option = QSpinBox(self.settings_ui_groupbox)
        ...
        self.formLayout.setWidget(8, QFormLayout.FieldRole, self.joint_size_option)
        self.zoomby_label = QLabel(self.settings_ui_groupbox)
        self.zoomby_label.setObjectName("zoomby_label")
        self.formLayout.setWidget(9, QFormLayout.LabelRole, self.zoomby_label)
        self.zoom_by_option = QComboBox(self.settings_ui_groupbox)
        self.zoom_by_option.setObjectName("zoom_by_option")
        self.zoom_by_option.addItem("")
        self.zoom_by_option.addItem("")
        self.formLayout.setWidget(9, QFormLayout.FieldRole, self.zoom_by_option)
        self.snap_label = QLabel(self.settings_ui_groupbox)
        self.snap_label.setObjectName("snap_label")
        self.formLayout.setWidget(10, QFormLayout.LabelRole, self.snap_label)
        self.snap_option = QDoubleSpinBox(self.settings_ui_groupbox)
        self.snap_option.setMaximum(50.0)
        self.snap_option.setObjectName("snap_option")
        self.formLayout.setWidget(10, QFormLayout.FieldRole, self.snap_option)
        self.background_label = QLabel(self.settings_ui_groupbox)
        self.background_label.setObjectName("background_label")
        self.formLayout.setWidget(11, QFormLayout.LabelRole, self.background_label)
        self.background_layout = QHBoxLayout()
        self.background_layout.setObjectName("background_layout")
        self.background_option = QLineEdit(self.settings_ui_groupbox)
        self.background_option.setObjectName("background_option")
        self.background_layout.addWidget(self.background_option)
        self.background_choose_dir = QToolButton(self.settings_ui_groupbox)
        ...
        self.formLayout.setLayout(11, QFormLayout.FieldRole, self.background_layout)
        self.background_opacity_label = QLabel(self.settings_ui_groupbox)
        self.background_opacity_label.setObjectName("background_opacity_label")
        self.formLayout.setWidget(12, QFormLayout.LabelRole, self.background_opacity_label)
        self.background_opacity_option = QDoubleSpinBox(self.settings_ui_groupbox)
        ...
        self.formLayout.setWidget(12, QFormLayout.FieldRole, self.background_opacity_option)
        self.background_scale_label = QLabel(self.settings_ui_groupbox)
        self.background_scale_label.setObjectName("background_scale_label")
        self.formLayout.setWidget(13, QFormLayout.LabelRole, self.background_scale_label)
        self.background_scale_option = QDoubleSpinBox(self.settings_ui_groupbox)
        ...
        self.formLayout.setWidget(13, QFormLayout.FieldRole, self.background_scale_option)
        self.background_offset_label = QLabel(self.settings_ui_groupbox)
        self.background_offset_label.setObjectName("background_offset_label")
        self.formLayout.setWidget(14, QFormLayout.LabelRole, self.background_offset_label)
        self.background_offset_layout = QHBoxLayout()
        self.background_offset_layout.setObjectName("background_offset_layout")
        self.background_offset_x_option = QDoubleSpinBox(self.settings_ui_groupbox)
        ...
        self.background_offset_y_option = QDoubleSpinBox(self.settings_ui_groupbox)
        ...
        self.formLayout.setLayout(14, QFormLayout.FieldRole, self.background_offset_layout)
        self.verticalLayout_3.addWidget(self.settings_ui_groupbox)
        self.settings_history_groupbox = QGroupBox(self.scrollAreaWidgetContents)
        self.settings_history_groupbox.setObjectName("settings_history_groupbox")
        self.formLayout_2 = QFormLayout(self.settings_history_groupbox)
        self.formLayout_2.setObjectName("formLayout_2")
        self.UndoLimit_label = QLabel(self.settings_history_groupbox)
        self.UndoLimit_label.setObjectName("UndoLimit_label")
        self.formLayout_2.setWidget(0, QFormLayout.LabelRole, self.UndoLimit_label)
        self.undo_limit_option = QSpinBox(self.settings_history_groupbox)
        self.undo_limit_option.setMinimum(5)
        self.undo_limit_option.setObjectName("undo_limit_option")
        self.formLayout_2.setWidget(0, QFormLayout.FieldRole, self.undo_limit_option)
        self.verticalLayout_3.addWidget(self.settings_history_groupbox)
        self.settings_kernels_groupBox = QGroupBox(self.scrollAreaWidgetContents)
        self.settings_kernels_groupBox.setObjectName("settings_kernels_groupBox")
        self.formLayout_3 = QFormLayout(self.settings_kernels_groupBox)
        self.formLayout_3.setObjectName("formLayout_3")
        self.planarsolver_label = QLabel(self.settings_kernels_groupBox)
        self.planarsolver_label.setObjectName("planarsolver_label")
        self.formLayout_3.setWidget(0, QFormLayout.LabelRole, self.planarsolver_label)
        self.planar_solver_option = QComboBox(self.settings_kernels_groupBox)
        self.planar_solver_option.setObjectName("planar_solver_option")
        self.formLayout_3.setWidget(0, QFormLayout.FieldRole, self.planar_solver_option)
        self.pathpreview_label = QLabel(self.settings_kernels_groupBox)
        self.pathpreview_label.setObjectName("pathpreview_label")
        self.formLayout_3.setWidget(1, QFormLayout.LabelRole, self.pathpreview_label)
        self.path_preview_option = QComboBox(self.settings_kernels_groupBox)
        self.path_preview_option.setObjectName("path_preview_option")
        self.formLayout_3.setWidget(1, QFormLayout.FieldRole, self.path_preview_option)
        self.verticalLayout_3.addWidget(self.settings_kernels_groupBox)
        self.settings_misc_groupBox = QGroupBox(self.scrollAreaWidgetContents)
        self.settings_misc_groupBox.setObjectName("settings_misc_groupBox")
        self.verticalLayout_7 = QVBoxLayout(self.settings_misc_groupBox)
        self.verticalLayout_7.setObjectName("verticalLayout_7")
        self.title_full_path_option = QCheckBox(self.settings_misc_groupBox)
        ...
        self.console_error_option = QCheckBox(self.settings_misc_groupBox)
        ...
        spacerItem2 = QSpacerItem(20, 619, QSizePolicy.Minimum, QSizePolicy.Expanding)
        self.verticalLayout_3.addItem(spacerItem2)
        self.horizontalLayout = QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.dontsave_option = QCheckBox(self.scrollAreaWidgetContents)
        ...
        self.settings_reset = QPushButton(self.settings_tab)
        ...
        icon16 = QIcon()
        icon16.addPixmap(QPixmap(":/icons/settings.png"), QIcon.Normal, QIcon.Off)
        self.main_panel.addTab(self.settings_tab, icon16, "")
        self.verticalLayout_31.addWidget(self.main_panel)
        self.RightSplitter = QSplitter(self.main_splitter)
        self.RightSplitter.setOrientation(Qt.Vertical)
        self.RightSplitter.setObjectName("RightSplitter")
        self.histogramArea = QWidget(self.RightSplitter)
        self.histogramArea.setObjectName("histogramArea")
        self.horizontalLayout_2 = QHBoxLayout(self.histogramArea)
        self.horizontalLayout_2.setContentsMargins(3, 3, 3, 3)
        self.horizontalLayout_2.setSpacing(3)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.line = QFrame(self.histogramArea)
        self.line.setFrameShadow(QFrame.Sunken)
        self.line.setLineWidth(4)
        self.line.setFrameShape(QFrame.VLine)
        self.line.setObjectName("line")
        self.horizontalLayout_2.addWidget(self.line)
        self.canvas_splitter = QSplitter(self.histogramArea)
        ...
        self.BrowserWidget = QWidget(self.canvas_splitter)
        self.BrowserWidget.setMaximumSize(QSize(16777215, 50))
        self.BrowserWidget.setObjectName("BrowserWidget")
        self.horizontalLayout_7 = QHBoxLayout(self.BrowserWidget)
        self.horizontalLayout_7.setContentsMargins(3, 3, 3, 3)
        self.horizontalLayout_7.setObjectName("horizontalLayout_7")
        self.zoom_bar = QSlider(self.BrowserWidget)
        ...
        self.ResetCanvas = QPushButton(self.BrowserWidget)
        sizePolicy = QSizePolicy(QSizePolicy.Fixed, QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        icon17 = QIcon()
        icon17.addPixmap(QPixmap(":/icons/aim.png"), QIcon.Normal, QIcon.Off)
        self.ResetCanvas.setIcon(icon17)
        self.ResetCanvas.setIconSize(QSize(32, 32))
        self.ResetCanvas.setObjectName("ResetCanvas")
        self.horizontalLayout_7.addWidget(self.ResetCanvas)
        self.free_move_button = QPushButton(self.BrowserWidget)
        icon18 = QIcon()
        icon18.addPixmap(QPixmap(":/icons/free_move_off.png"), QIcon.Normal, QIcon.Off)
        self.free_move_button.setIcon(icon18)
        self.free_move_button.setIconSize(QSize(32, 32))
        self.free_move_button.setObjectName("free_move_button")
        self.horizontalLayout_7.addWidget(self.free_move_button)
        self.line_3 = QFrame(self.BrowserWidget)
        self.line_3.setFrameShape(QFrame.VLine)
        self.line_3.setFrameShadow(QFrame.Sunken)
        self.line_3.setObjectName("line_3")
        self.horizontalLayout_7.addWidget(self.line_3)
        self.DOFLable = QLabel(self.BrowserWidget)
        sizePolicy = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.console_disconnect_button = QPushButton(self.widget)
        icon19 = QIcon()
        icon19.addPixmap(QPixmap(":/icons/disconnect.png"), QIcon.Normal, QIcon.Off)
        ...
        self.console_connect_button = QPushButton(self.widget)
        icon20 = QIcon()
        icon20.addPixmap(QPixmap(":/icons/connect.png"), QIcon.Normal, QIcon.Off)
        ...
        self.clearConsole = QPushButton(self.widget)
        self.clearConsole.setIcon(icon3)
        ...
        self.console_widget_browser = QTextBrowser(self.console_widget)
        ...
        self.menu_bar.setGeometry(QRect(0, 0, 882, 31))
        ...
        self.menuImport = QMenu(self.menu_file)
        self.menuImport.setObjectName("menuImport")
        self.menu_mechanism = QMenu(self.menu_bar)
        ...
        self.action_new_workbook = QAction(MainWindow)
        icon21 = QIcon()
        icon21.addPixmap(QPixmap(":/icons/new_file.png"), QIcon.Normal, QIcon.Off)
        self.action_new_workbook.setIcon(icon21)
        self.action_new_workbook.setShortcutContext(Qt.WindowShortcut)
        self.action_new_workbook.setObjectName("action_new_workbook")
        self.action_new_point = QAction(MainWindow)
        self.action_new_point.setIcon(icon1)
        self.action_new_point.setObjectName("action_new_point")
        self.action_new_link = QAction(MainWindow)
        ...
        icon22 = QIcon()
        icon22.addPixmap(QPixmap(":/icons/exit.png"), QIcon.Normal, QIcon.Off)
        self.action_exit.setIcon(icon22)
        self.action_exit.setObjectName("action_exit")
        self.action_mde_tw = QAction(MainWindow)
        icon23 = QIcon()
        icon23.addPixmap(QPixmap(":/icons/kmol.png"), QIcon.Normal, QIcon.Off)
        self.action_mde_tw.setIcon(icon23)
        self.action_mde_tw.setObjectName("action_mde_tw")
        self.action_github_repository = QAction(MainWindow)
        icon24 = QIcon()
        icon24.addPixmap(QPixmap(":/icons/github.png"), QIcon.Normal, QIcon.Off)
        self.action_github_repository.setIcon(icon24)
        self.action_github_repository.setObjectName("action_github_repository")
        self.action_about = QAction(MainWindow)
        icon25 = QIcon()
        icon25.addPixmap(QPixmap(":/icons/main.png"), QIcon.Normal, QIcon.Off)
        self.action_about.setIcon(icon25)
        self.action_about.setObjectName("action_about")
        self.action_full_screen = QAction(MainWindow)
        self.action_full_screen.setCheckable(True)
        icon26 = QIcon()
        icon26.addPixmap(QPixmap(":/icons/fullscreen.png"), QIcon.Normal, QIcon.Off)
        self.action_full_screen.setIcon(icon26)
        self.action_full_screen.setObjectName("action_full_screen")
        self.action_export_image = QAction(MainWindow)
        icon27 = QIcon()
        icon27.addPixmap(QPixmap(":/icons/picture.png"), QIcon.Normal, QIcon.Off)
        self.action_export_image.setIcon(icon27)
        self.action_export_image.setObjectName("action_export_image")
        self.action_commit = QAction(MainWindow)
        self.action_commit.setIcon(icon15)
        self.action_commit.setPriority(QAction.HighPriority)
        self.action_commit.setObjectName("action_commit")
        self.action_python_script = QAction(MainWindow)
        icon28 = QIcon()
        icon28.addPixmap(QPixmap(":/icons/script.png"), QIcon.Normal, QIcon.Off)
        self.action_python_script.setIcon(icon28)
        self.action_python_script.setObjectName("action_python_script")
        self.action_delete_point = QAction(MainWindow)
        self.action_delete_point.setObjectName("action_delete_point")
        self.action_delete_link = QAction(MainWindow)
        self.action_delete_link.setObjectName("action_delete_link")
        self.action_edit_point = QAction(MainWindow)
        self.action_edit_point.setObjectName("action_edit_point")
        self.action_edit_link = QAction(MainWindow)
        self.action_edit_link.setObjectName("action_edit_link")
        self.action_show_dimensions = QAction(MainWindow)
        self.action_show_dimensions.setCheckable(True)
        self.action_show_dimensions.setObjectName("action_show_dimensions")
        self.action_show_point_mark = QAction(MainWindow)
        ...
        self.action_export_dxf = QAction(MainWindow)
        icon29 = QIcon()
        icon29.addPixmap(QPixmap(":/icons/dxf.png"), QIcon.Normal, QIcon.Off)
        self.action_export_dxf.setIcon(icon29)
        self.action_export_dxf.setObjectName("action_export_dxf")
        self.action_commit_as = QAction(MainWindow)
        self.action_commit_as.setIcon(icon15)
        self.action_commit_as.setObjectName("action_commit_as")
        self.action_export_slvs = QAction(MainWindow)
        icon30 = QIcon()
        icon30.addPixmap(QPixmap(":/icons/solvespace.ico"), QIcon.Normal, QIcon.Off)
        self.action_export_slvs.setIcon(icon30)
        self.action_export_slvs.setObjectName("action_export_slvs")
        self.action_title_slvs = QAction(MainWindow)
        self.action_title_slvs.setEnabled(False)
        self.action_title_slvs.setObjectName("action_title_slvs")
        self.action_title_dxf = QAction(MainWindow)
        self.action_title_dxf.setEnabled(False)
        self.action_title_dxf.setObjectName("action_title_dxf")
        self.action_title_other = QAction(MainWindow)
        self.action_title_other.setEnabled(False)
        self.action_title_other.setObjectName("action_title_other")
        self.action_import_database = QAction(MainWindow)
        icon31 = QIcon()
        icon31.addPixmap(QPixmap(":/icons/loadfile.png"), QIcon.Normal, QIcon.Off)
        self.action_import_database.setIcon(icon31)
        self.action_import_database.setObjectName("action_import_database")
        self.action_about_qt = QAction(MainWindow)
        icon32 = QIcon()
        icon32.addPixmap(QPixmap(":/icons/qt.png"), QIcon.Normal, QIcon.Off)
        self.action_about_qt.setIcon(icon32)
        self.action_about_qt.setObjectName("action_about_qt")
        self.action_load_file = QAction(MainWindow)
        self.action_load_file.setIcon(icon31)
        self.action_load_file.setObjectName("action_load_file")
        self.action_zoom_to_fit = QAction(MainWindow)
        self.action_zoom_to_fit.setIcon(icon17)
        self.action_zoom_to_fit.setObjectName("action_zoom_to_fit")
        self.action_path_style = QAction(MainWindow)
        ...
        self.action_pyslvs_com = QAction(MainWindow)
        self.action_pyslvs_com.setIcon(icon)
        self.action_pyslvs_com.setObjectName("action_pyslvs_com")
        self.action_show_console = QAction(MainWindow)
        self.action_show_console.setCheckable(True)
        icon33 = QIcon()
        icon33.addPixmap(QPixmap(":/icons/konsole.png"), QIcon.Normal, QIcon.Off)
        self.action_show_console.setIcon(icon33)
        self.action_show_console.setObjectName("action_show_console")
        self.action_export_pmks_url = QAction(MainWindow)
        icon34 = QIcon()
        icon34.addPixmap(QPixmap(":/icons/pmks.png"), QIcon.Normal, QIcon.Off)
        self.action_export_pmks_url.setIcon(icon34)
        self.action_export_pmks_url.setObjectName("action_export_pmks_url")
        self.action_import_pmks_url = QAction(MainWindow)
        self.action_import_pmks_url.setIcon(icon34)
        self.action_import_pmks_url.setObjectName("action_import_pmks_url")
        self.action_example = QAction(MainWindow)
        icon35 = QIcon()
        icon35.addPixmap(QPixmap(":/icons/example.png"), QIcon.Normal, QIcon.Off)
        self.action_example.setIcon(icon35)
        self.action_example.setObjectName("action_example")
        self.action_exprsion = QAction(MainWindow)
        self.action_exprsion.setIcon(icon28)
        self.action_exprsion.setObjectName("action_exprsion")
        self.action_commit_branch = QAction(MainWindow)
        self.action_commit_branch.setIcon(icon15)
        self.action_commit_branch.setObjectName("action_commit_branch")
        self.action_stash = QAction(MainWindow)
        self.action_stash.setIcon(icon10)
        self.action_stash.setObjectName("action_stash")
        self.action_import_example = QAction(MainWindow)
        self.action_import_example.setIcon(icon35)
        self.action_import_example.setObjectName("action_import_example")
        self.action_export_image_clipboard = QAction(MainWindow)
        self.action_export_image_clipboard.setIcon(icon27)
        ...
        icon36 = QIcon()
        icon36.addPixmap(QPixmap(":/icons/new_window.png"), QIcon.Normal, QIcon.Off)
        self.action_new_window.setIcon(icon36)
        self.action_new_window.setObjectName("action_new_window")
        self.action_scale_points = QAction(MainWindow)
        self.action_scale_points.setObjectName("action_scale_points")
        self.action_save = QAction(MainWindow)
        icon37 = QIcon()
        icon37.addPixmap(QPixmap(":/icons/yaml.png"), QIcon.Normal, QIcon.Off)
        self.action_save.setIcon(icon37)
        self.action_save.setObjectName("action_save")
        self.action_save_as = QAction(MainWindow)
        self.action_save_as.setIcon(icon37)
        self.action_save_as.setObjectName("action_save_as")
        self.menu_export.addAction(self.action_title_slvs)
        self.menu_export.addAction(self.action_export_slvs)
        self.menu_export.addSeparator()
        self.menu_export.addAction(self.action_title_dxf)
        self.menu_export.addAction(self.action_export_dxf)
        self.menu_export.addSeparator()
        self.menu_export.addAction(self.action_title_other)
        ...
        self.menuImport.addAction(self.action_import_pmks_url)
        self.menuImport.addAction(self.action_import_example)
        self.menuImport.addAction(self.action_import_database)
        ...
        self.menu_options.addAction(self.action_python_script)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_delete_point.setText(_translate("MainWindow", "Delete the Point"))
        self.action_delete_point.setStatusTip(_translate("MainWindow", "Delete an existing point."))
        self.action_delete_link.setText(_translate("MainWindow", "Delete the Link"))
        ...
        self.action_edit_link.setText(_translate("MainWindow", "Edit the Link"))
        ...
        self.action_export_dxf.setText(_translate("MainWindow", "2D Sketch"))
        ...
        self.action_export_slvs.setText(_translate("MainWindow", "&2D Sketch"))
        ...
        self.action_exprsion.setText(_translate("MainWindow", "Get Expression"))
        ...
        self.action_export_image_clipboard.setText(_translate("MainWindow", "Image with Clipboard"))
