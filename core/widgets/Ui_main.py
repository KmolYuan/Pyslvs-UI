...
"}")
        ...
        self.main_panel.addTab(self.project_tab, icon4, "")
        ...
        self.menu_bar.setGeometry(QtCore.QRect(0, 0, 1023, 41))
        ...
        icon28 = QtGui.QIcon()
        icon28.addPixmap(QtGui.QPixmap(":/icons/qt.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_about_qt.setIcon(icon28)
