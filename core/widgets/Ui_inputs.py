...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.joint_groupBox = QGroupBox(Form)
        self.joint_groupBox.setObjectName("joint_groupBox")
        self.horizontalLayout = QHBoxLayout(self.joint_groupBox)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.verticalLayout_13 = QVBoxLayout()
        self.verticalLayout_13.setObjectName("verticalLayout_13")
        self.joint_list_lable = QLabel(self.joint_groupBox)
        self.joint_list_lable.setObjectName("joint_list_lable")
        self.verticalLayout_13.addWidget(self.joint_list_lable)
        self.joint_list = QListWidget(self.joint_groupBox)
        self.joint_list.setEditTriggers(QAbstractItemView.NoEditTriggers)
        ...
        self.inputs_label_right2 = QLabel(self.joint_groupBox)
        ...
        self.driver_list_lable = QLabel(self.joint_groupBox)
        self.driver_list_lable.setObjectName("driver_list_lable")
        self.verticalLayout_16.addWidget(self.driver_list_lable)
        self.driver_list = QListWidget(self.joint_groupBox)
        self.driver_list.setEditTriggers(QAbstractItemView.NoEditTriggers)
        self.driver_list.setObjectName("driver_list")
        self.verticalLayout_16.addWidget(self.driver_list)
        self.variable_add = QPushButton(self.joint_groupBox)
        self.variable_add.setEnabled(False)
        icon = QIcon()
        icon.addPixmap(QPixmap(":/icons/arrow_down.png"), QIcon.Normal, QIcon.Off)
        ...
        self.variable_groupBox = QGroupBox(Form)
        self.variable_groupBox.setObjectName("variable_groupBox")
        self.verticalLayout_4 = QVBoxLayout(self.variable_groupBox)
        self.verticalLayout_4.setObjectName("verticalLayout_4")
        self.inputs_dial_layout = QHBoxLayout()
        self.inputs_dial_layout.setObjectName("inputs_dial_layout")
        self.verticalLayout_5 = QVBoxLayout()
        self.verticalLayout_5.setObjectName("verticalLayout_5")
        self.variable_up = QPushButton(self.variable_groupBox)
        icon1 = QIcon()
        icon1.addPixmap(QPixmap(":/icons/arrow_up.png"), QIcon.Normal, QIcon.Off)
        ...
        self.variable_down = QPushButton(self.variable_groupBox)
        ...
        self.variable_remove = QPushButton(self.variable_groupBox)
        icon2 = QIcon()
        icon2.addPixmap(QPixmap(":/icons/delete.png"), QIcon.Normal, QIcon.Off)
        ...
        self.variable_list = QListWidget(self.variable_groupBox)
        ...
        self.line_5 = QFrame(self.variable_groupBox)
        ...
        self.extremeRebound = QCheckBox(self.variable_groupBox)
        ...
        self.variable_play = QPushButton(self.variable_groupBox)
        self.variable_play.setEnabled(False)
        icon3 = QIcon()
        icon3.addPixmap(QPixmap(":/icons/play.png"), QIcon.Normal, QIcon.Off)
        icon3.addPixmap(QPixmap(":/icons/pause.png"), QIcon.Active, QIcon.On)
        ...
        self.variable_stop = QPushButton(self.variable_groupBox)
        icon4 = QIcon()
        icon4.addPixmap(QPixmap(":/icons/interrupted.png"), QIcon.Normal, QIcon.Off)
        ...
        self.dial_spinbox = QDoubleSpinBox(self.variable_groupBox)
        ...
        self.update_pos_option = QCheckBox(self.variable_groupBox)
        ...
        self.update_pos = QPushButton(self.variable_groupBox)
        icon5 = QIcon()
        icon5.addPixmap(QPixmap(":/icons/data_update.png"), QIcon.Normal, QIcon.Off)
        ...
        self.record_groupBox = QGroupBox(Form)
        self.record_groupBox.setObjectName("record_groupBox")
        self.verticalLayout_22 = QVBoxLayout(self.record_groupBox)
        self.verticalLayout_22.setObjectName("verticalLayout_22")
        self.horizontalLayout_6 = QHBoxLayout()
        self.horizontalLayout_6.setObjectName("horizontalLayout_6")
        self.record_show = QCheckBox(self.record_groupBox)
        ...
        self.record_interval_label = QLabel(self.record_groupBox)
        ...
        self.record_interval = QDoubleSpinBox(self.record_groupBox)
        ...
        self.record_list = QListWidget(self.record_groupBox)
        ...
        self.update_preview_button = QPushButton(self.record_groupBox)
        ...
        self.record_start = QPushButton(self.record_groupBox)
        icon6 = QIcon()
        icon6.addPixmap(QPixmap(":/icons/record.png"), QIcon.Normal, QIcon.Off)
        ...
        self.record_remove = QPushButton(self.record_groupBox)
