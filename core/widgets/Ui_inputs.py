...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.variable_up.setToolTip(_translate("Form", "Upgrade priority of the variable."))
        self.variable_down.setToolTip(_translate("Form", "Downgrade priority of the variable."))
        ...
        self.update_preview_button.setToolTip(_translate("Form", "Refresh preview path data."))
