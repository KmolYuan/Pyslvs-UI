...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.kinematics = QtWidgets.QWidget()
        self.kinematics.setObjectName("kinematics")
        self.verticalLayout_9 = QtWidgets.QVBoxLayout(self.kinematics)
        self.verticalLayout_9.setObjectName("verticalLayout_9")
        self.label = QtWidgets.QLabel(self.kinematics)
        self.label.setObjectName("label")
        self.verticalLayout_9.addWidget(self.label)
        spacerItem3 = QtWidgets.QSpacerItem(20, 429, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_9.addItem(spacerItem3)
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.kinematicsSolveButton = QtWidgets.QPushButton(self.kinematics)
        self.kinematicsSolveButton.setObjectName("kinematicsSolveButton")
        self.horizontalLayout.addWidget(self.kinematicsSolveButton)
        spacerItem4 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout.addItem(spacerItem4)
        self.verticalLayout_9.addLayout(self.horizontalLayout)
        self.information_tab.addTab(self.kinematics, "")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "<html><head/><body><p><span style=\" font-size:14pt;\">Kinematics solver will take some time in solving this result.<br/>Click the &quot;Solve&quot; button to start this process.</span></p></body></html>"))
        self.kinematicsSolveButton.setText(_translate("Dialog", "Solve"))
        self.information_tab.setTabText(self.information_tab.indexOf(self.kinematics), _translate("Dialog", "Kinematics"))
