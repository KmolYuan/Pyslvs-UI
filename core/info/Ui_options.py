...
# Form implementation generated from reading ui file 'C:\Users\ahshoe\Desktop\Pyslvs-PyQt5\core\info\options.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.horizontalLayout_2.addWidget(self.EnvVariable)
        self.FileLocate = QtWidgets.QPushButton(self.general_tab)
        self.FileLocate.setMaximumSize(QtCore.QSize(25, 16777215))
        self.FileLocate.setObjectName("FileLocate")
        self.horizontalLayout_2.addWidget(self.FileLocate)
        self.gridLayout.addLayout(self.horizontalLayout_2, 0, 1, 1, 1)
        self.ZoomFactor = QtWidgets.QSpinBox(self.general_tab)
        self.ZoomFactor.setMinimum(100)
        self.ZoomFactor.setMaximum(1000)
        self.ZoomFactor.setProperty("value", 200)
        ...
        self.OpenLastFile = QtWidgets.QCheckBox(self.general_tab)
        self.OpenLastFile.setChecked(False)
        self.OpenLastFile.setObjectName("OpenLastFile")
        self.verticalLayout_4.addWidget(self.OpenLastFile)
        ...
        self.LinkingLinesColor = QtWidgets.QComboBox(self.appearance_tab)
        self.LinkingLinesColor.setObjectName("LinkingLinesColor")
        self.gridLayout_2.addWidget(self.LinkingLinesColor, 0, 1, 1, 1)
        self.AuxiliaryLineColor = QtWidgets.QComboBox(self.appearance_tab)
        self.AuxiliaryLineColor.setObjectName("AuxiliaryLineColor")
        self.gridLayout_2.addWidget(self.AuxiliaryLineColor, 2, 1, 1, 1)
        self.StayChainColor = QtWidgets.QComboBox(self.appearance_tab)
        self.StayChainColor.setObjectName("StayChainColor")
        self.gridLayout_2.addWidget(self.StayChainColor, 1, 1, 1, 1)
        self.AuxiliaryLimitLineColor = QtWidgets.QComboBox(self.appearance_tab)
        self.AuxiliaryLimitLineColor.setObjectName("AuxiliaryLimitLineColor")
        self.gridLayout_2.addWidget(self.AuxiliaryLimitLineColor, 3, 1, 1, 1)
        ...
        self.label_10 = QtWidgets.QLabel(self.appearance_tab)
        self.label_10.setObjectName("label_10")
        self.gridLayout_2.addWidget(self.label_10, 4, 0, 1, 1)
        self.TextColor = QtWidgets.QComboBox(self.appearance_tab)
        self.TextColor.setObjectName("TextColor")
        self.gridLayout_2.addWidget(self.TextColor, 4, 1, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.FileLocate.setText(_translate("Dialog", "..."))
        self.label_3.setText(_translate("Dialog", "Table Tool Location:"))
        self.OpenLastFile.setText(_translate("Dialog", "Open the last file when starting."))
        ...
        self.label_6.setText(_translate("Dialog", "Linking Lines Color:"))
        ...
        self.label_10.setText(_translate("Dialog", "Text Color:"))
