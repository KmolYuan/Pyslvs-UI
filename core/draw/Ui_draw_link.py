...
# Form implementation generated from reading ui file '/home/ahshoe/Desktop/Pyslvs-PyQt5/core/draw/draw_link.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.Link_num.setMaximumSize(QtCore.QSize(16777215, 30))
        self.Link_num.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.Link_num.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.Link_num.setObjectName("Link_num")
        self.verticalLayout.addWidget(self.Link_num)
        ...
        self.gridLayout.addWidget(self.Start_Point, 2, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.End_Point, 2, 2, 1, 1)
        self.Length = QtWidgets.QLineEdit(Dialog)
        self.Length.setObjectName("Length")
        self.gridLayout.addWidget(self.Length, 2, 0, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.Length.setPlaceholderText(_translate("Dialog", "10.0"))
