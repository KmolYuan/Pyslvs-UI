...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 485, 462))
        ...
        self.moveUp.setText("")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/arrow_up.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icons/arrow_down.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.advanceButton.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icons/ZeroMQ.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.GenerateZMQ.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icons/local.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.GenerateLocal.setIcon(icon7)
    ...
    def retranslateUi(self, Form):
        ...
        self.type0.setToolTip(_translate("Form", "<html><head/><body><p><span style=\" font-size:xx-large; font-weight:600;\">Real-valued Genetic Algorithm</span></p><p><span style=\" font-family:\'sans-serif\'; font-size:10pt; color:#222222;\">From Wikipedia:</span></p><p><span style=\" font-size:10pt;\">In a genetic algorithm, apopulation of candidate solutions (called individuals, creatures, or phenotypes) to an optimization problem is evolved toward better solutions. Each candidate solution has a set of properties (its chromosomes or genotype) which can be mutated and altered; traditionally, solutions are represented in binary as strings of 0s and 1s, but other encodings are also possible.</span></p><p><span style=\" font-size:10pt;\">The evolution usually starts from a population of randomly generated individuals, and is aniterative process, with the population in each iteration called a generation. In each generation, the fitness of every individual in the population is evaluated; the fitness is usually the value of the objective function in the optimization problem being solved. The more fit individuals are stochastically selected from the current population, and each individual\'s genome is modified (recombined and possibly randomly mutated) to form a new generation. The new generation of candidate solutions is then used in the next iteration of the algorithm. Commonly, the algorithm terminates when either a maximum number of generations has been produced, or a satisfactory fitness level has been reached for the population.</span></p></body></html>"))
        self.type0.setText(_translate("Form", "Genetic Algorithm [RGA] (?)"))
        self.type1.setToolTip(_translate("Form", "<html><head/><body><p><span style=\" font-size:xx-large; font-weight:600;\">Firefly Algorithm</span></p><p><span style=\" font-family:\'sans-serif\'; font-size:10pt; color:#222222;\">From Wikipedia:</span></p><p><span style=\" font-size:10pt;\">The primary purpose for a firefly\'s flash is to act as a signal system to attract other fireflies. Xin-She Yang formulated this firefly algorithm by assuming:</span></p><p><span style=\" font-size:10pt;\">All fireflies are unisexual, so that any individual firefly will be attracted to all other fireflies; Attractiveness is proportional to their brightness, and for any two fireflies, the less bright one will be attracted by (and thus move towards) the brighter one; however, the intensity (apparent brightness) decrease as their mutual distance increases; If there are no fireflies brighter than a given firefly, it will move randomly.</span></p><p><span style=\" font-size:10pt;\">The brightness should be associated with the objective function.</span></p></body></html>"))
        self.type1.setText(_translate("Form", "Firefly Algorithm [Firefly] (?)"))
        self.type2.setToolTip(_translate("Form", "<html><head/><body><p><span style=\" font-size:xx-large; font-weight:600;\">Differential Evolution</span></p><p><span style=\" font-family:\'sans-serif\'; font-size:10pt; color:#222222;\">From Wikipedia:</span></p><p><span style=\" font-size:10pt;\">In evolutionary computation, differential evolution (DE) is a method that optimizes a problem by iteratively trying to improve a candidate solution with regard to a given measure of quality. Such methods are commonly known as metaheuristics as they make few or no assumptions about the problem being optimized and can search very large spaces of candidate solutions. However, metaheuristics such as DE do not guarantee an optimal solution is ever found.</span></p><p><span style=\" font-size:10pt;\">DE is used for multidimensional real-valued functions but does not use the gradient of the problem being optimized, which means DE does not require for the optimization problem to be differentiable as is required by classic optimization methods such as gradient descent and quasi-newton methods. DE can therefore also be used on optimization problems that are not even continuous, are noisy, change over time, etc.</span></p><p><span style=\" font-size:10pt;\">DE optimizes a problem by maintaining a population of candidate solutions and creating new candidate solutions by combining existing ones according to its simple formulae, and then keeping whichever candidate solution has the best score or fitness on the optimization problem at hand. In this way the optimization problem is treated as a black box that merely provides a measure of quality given a candidate solution and the gradient is therefore not needed.</span></p></body></html>"))
