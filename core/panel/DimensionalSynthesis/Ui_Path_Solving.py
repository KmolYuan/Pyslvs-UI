...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.horizontalLayout_8.addWidget(self.EightBar)
    ...
    def retranslateUi(self, Form):
        ...
        self.series.setStatusTip(_translate("Form", "Generat points by formula."))
        self.series.setText(_translate("Form", "Formula ..."))
        self.importCSV.setStatusTip(_translate("Form", "Import path by CSV format."))
        self.importXLSX.setStatusTip(_translate("Form", "Import path by Microsoft Excel format."))
