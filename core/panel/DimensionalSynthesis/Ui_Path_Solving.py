...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 433, 430))
        ...
        self.Generate = QtWidgets.QPushButton(self.timePanel)
        self.Generate.setMinimumSize(QtCore.QSize(100, 0))
        self.Generate.setAutoDefault(True)
        self.Generate.setObjectName("Generate")
        self.timePanelLayout.addWidget(self.Generate)
