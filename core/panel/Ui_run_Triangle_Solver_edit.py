...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.setMinimumSize(QtCore.QSize(750, 310))
        Dialog.setMaximumSize(QtCore.QSize(932, 310))
        icon = QtGui.QIcon()
        ...
        self.p2Layout_2 = QtWidgets.QWidget(self.p3Panel)
        self.p2Layout_2.setObjectName("p2Layout_2")
        self.horizontalLayout_5 = QtWidgets.QHBoxLayout(self.p2Layout_2)
        self.horizontalLayout_5.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_5.setObjectName("horizontalLayout_5")
        self.label_13 = QtWidgets.QLabel(self.p2Layout_2)
        self.label_13.setObjectName("label_13")
        self.horizontalLayout_5.addWidget(self.label_13)
        self.x3 = QtWidgets.QDoubleSpinBox(self.p2Layout_2)
        self.x3.setMinimum(-99.99)
        self.x3.setObjectName("x3")
        self.horizontalLayout_5.addWidget(self.x3)
        self.label_14 = QtWidgets.QLabel(self.p2Layout_2)
        self.label_14.setObjectName("label_14")
        self.horizontalLayout_5.addWidget(self.label_14)
        self.y3 = QtWidgets.QDoubleSpinBox(self.p2Layout_2)
        self.y3.setMinimum(-99.99)
        self.y3.setObjectName("y3")
        self.horizontalLayout_5.addWidget(self.y3)
        self.verticalLayout_8.addWidget(self.p2Layout_2)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.p1Panel.setTitle(_translate("Dialog", "Point1"))
        ...
        self.p2Panel.setTitle(_translate("Dialog", "Point2"))
        ...
        self.label_11.setText(_translate("Dialog", "y2:"))
        self.p2Result.setText(_translate("Dialog", "From Result"))
        self.label_2.setText(_translate("Dialog", "L0"))
        self.label_9.setText(_translate("Dialog", "R0"))
        self.label_4.setText(_translate("Dialog", "α "))
        self.angle.setSuffix(_translate("Dialog", "°"))
        self.p3Panel.setTitle(_translate("Dialog", "Point3"))
        self.p3Exist.setText(_translate("Dialog", "From Exist Point"))
        self.p3Customize.setText(_translate("Dialog", "Customize"))
        self.label_13.setText(_translate("Dialog", "x3:"))
        self.label_14.setText(_translate("Dialog", "y3:"))
