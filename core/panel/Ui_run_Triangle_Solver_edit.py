...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.triangleImage = QtWidgets.QLabel(self.PreviewPanel)
        ...
        self.valuePanel.setMinimumSize(QtCore.QSize(120, 0))
        self.valuePanel.setMaximumSize(QtCore.QSize(120, 16777215))
