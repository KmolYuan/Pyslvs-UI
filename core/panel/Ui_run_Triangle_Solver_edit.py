...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.merge.setItemText(0, _translate("Dialog", "Only points"))
        self.merge.setItemText(1, _translate("Dialog", "Linking L0"))
        self.merge.setItemText(2, _translate("Dialog", "Linking R0"))
        self.merge.setItemText(3, _translate("Dialog", "Stay Chain"))
