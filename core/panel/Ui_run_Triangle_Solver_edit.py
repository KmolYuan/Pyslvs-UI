...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.R1Customize.toggled['bool'].connect(self.valuePanel.setEnabled)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.R1Exist.setToolTip(_translate("Dialog", "This option will let  the exist point become to the result point."))
        self.R1Exist.setText(_translate("Dialog", "Is Exist Point (?)"))
