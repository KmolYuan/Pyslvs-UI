...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(936, 653)
        Dialog.setMinimumSize(QtCore.QSize(936, 653))
        Dialog.setMaximumSize(QtCore.QSize(936, 653))
        icon = QtGui.QIcon()
        ...
        self.rPanel = QtWidgets.QGroupBox(Dialog)
        self.rPanel.setObjectName("rPanel")
        self.verticalLayout_14 = QtWidgets.QVBoxLayout(self.rPanel)
        self.verticalLayout_14.setContentsMargins(6, 6, 6, 6)
        self.verticalLayout_14.setSpacing(6)
        self.verticalLayout_14.setObjectName("verticalLayout_14")
        self.R1Exist = QtWidgets.QRadioButton(self.rPanel)
        self.R1Exist.setObjectName("R1Exist")
        self.verticalLayout_14.addWidget(self.R1Exist)
        self.R1 = QtWidgets.QComboBox(self.rPanel)
        self.R1.setEnabled(False)
        self.R1.setObjectName("R1")
        self.verticalLayout_14.addWidget(self.R1)
        self.R1Customize = QtWidgets.QRadioButton(self.rPanel)
        self.R1Customize.setChecked(True)
        self.R1Customize.setObjectName("R1Customize")
        self.verticalLayout_14.addWidget(self.R1Customize)
        ...
        self.horizontalLayout_3.addWidget(self.rPanel)
        ...
        spacerItem7 = QtWidgets.QSpacerItem(20, 218, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        ...
        self.len1Exist = QtWidgets.QRadioButton(self.len1Panel)
        self.len1Exist.setEnabled(False)
        self.len1Exist.setObjectName("len1Exist")
        self.verticalLayout.addWidget(self.len1Exist)
        self.len1Customize = QtWidgets.QRadioButton(self.len1Panel)
        self.len1Customize.setChecked(True)
        self.len1Customize.setObjectName("len1Customize")
        self.verticalLayout.addWidget(self.len1Customize)
        ...
        self.len2Exist = QtWidgets.QRadioButton(self.len2Panel)
        self.len2Exist.setEnabled(False)
        self.len2Exist.setObjectName("len2Exist")
        self.verticalLayout_5.addWidget(self.len2Exist)
        self.len2Customize = QtWidgets.QRadioButton(self.len2Panel)
        self.len2Customize.setChecked(True)
        self.len2Customize.setObjectName("len2Customize")
        self.verticalLayout_5.addWidget(self.len2Customize)
        ...
        self.angleExist = QtWidgets.QRadioButton(self.anglePanel)
        self.angleExist.setEnabled(False)
        self.angleExist.setObjectName("angleExist")
        self.verticalLayout_4.addWidget(self.angleExist)
        self.angleCustomize = QtWidgets.QRadioButton(self.anglePanel)
        self.angleCustomize.setChecked(True)
        self.angleCustomize.setObjectName("angleCustomize")
        self.verticalLayout_4.addWidget(self.angleCustomize)
        ...
        self.len1Customize.toggled['bool'].connect(self.len1.setEnabled)
        self.len2Customize.toggled['bool'].connect(self.len2.setEnabled)
        self.angleCustomize.toggled['bool'].connect(self.angle.setEnabled)
        self.angleCustomize.toggled['bool'].connect(self.angleWise.setEnabled)
        self.R1Exist.toggled['bool'].connect(self.R1.setEnabled)
        self.R1Exist.toggled['bool'].connect(self.len1Exist.setEnabled)
        self.R1Exist.toggled['bool'].connect(self.angleExist.setEnabled)
        self.R1Exist.toggled['bool'].connect(self.len2Exist.setEnabled)
        self.R1Customize.toggled['bool'].connect(self.len1Customize.toggle)
        self.R1Customize.toggled['bool'].connect(self.angleCustomize.toggle)
        self.R1Customize.toggled['bool'].connect(self.len2Customize.toggle)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.rPanel.setTitle(_translate("Dialog", "Result Point"))
        self.R1Exist.setText(_translate("Dialog", "From Exist Point"))
        self.R1Customize.setText(_translate("Dialog", "New Point"))
        ...
        self.len1Exist.setText(_translate("Dialog", "From Exist Points"))
        self.len1Customize.setText(_translate("Dialog", "Customize"))
        self.len2Panel.setTitle(_translate("Dialog", "R0"))
        self.len2Exist.setText(_translate("Dialog", "From Exist Point"))
        self.len2Customize.setText(_translate("Dialog", "Customize"))
        self.anglePanel.setTitle(_translate("Dialog", "β"))
        self.angleExist.setText(_translate("Dialog", "From Exist Points"))
        self.angleCustomize.setText(_translate("Dialog", "Customize"))
