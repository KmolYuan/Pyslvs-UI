...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.moveUp = QtWidgets.QPushButton(Dialog)
        self.moveUp.setObjectName("moveUp")
        self.verticalLayout.addWidget(self.moveUp)
        self.moveDown = QtWidgets.QPushButton(Dialog)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_5.setText(_translate("Dialog", "<html><head/><body><p><span style=\" font-size:12pt; color:#00aa00;\">0 Point(s).</span></p></body></html>"))
