...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        item = QtWidgets.QTableWidgetItem()
        self.directionsTable.setHorizontalHeaderItem(5, item)
