...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(431, 653)
        icon = QIcon()
        icon.addPixmap(QPixmap(":/icons/git.png"), QIcon.Normal, QIcon.Off)
        Form.setWindowIcon(icon)
        self.verticalLayout_2 = QVBoxLayout(Form)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.horizontalLayout_5 = QHBoxLayout()
        self.horizontalLayout_5.setObjectName("horizontalLayout_5")
        self.CommitTable_text = QLabel(Form)
        ...
        self.commit_current_id = QSpinBox(Form)
        ...
        self.commit_search_text = QLineEdit(Form)
        ...
        self.CommitTable = QTableWidget(Form)
        ...
        self.CommitTable.setVerticalScrollMode(QAbstractItemView.ScrollPerPixel)
        self.CommitTable.setHorizontalScrollMode(QAbstractItemView.ScrollPerPixel)
        ...
        self.branch_current.setMaximumSize(QSize(93, 16777215))
        ...
        self.branch_checkout = QPushButton(Form)
        ...
        self.branch_delete = QPushButton(Form)
        icon1 = QIcon()
        ...
        self.commit_stash = QPushButton(Form)
