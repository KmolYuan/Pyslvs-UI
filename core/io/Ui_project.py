...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/id.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.overview_button.setIcon(icon1)
        ...
        self.ex_expression_button.setIcon(icon1)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/solvespace.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
