...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/pmks.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.ex_pmks_button.setIcon(icon3)
        ...
        self.verticalLayout_2.addWidget(self.export_group)
        ...
        self.im_pmks_button.setIcon(icon3)
        ...
        self.verticalLayout_2.addWidget(self.import_group)
