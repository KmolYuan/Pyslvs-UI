...
example_list = {
    ...
    "Crank slider":"M[J[R, color[Green], P[-67.38, 36.13], L[ground, link_0]], J[R, color[Green], P[-68.925, 55.925], L[link_0, link_1]], J[RP, A[0.0], color[Green], P[11.88, 0.0], L[ground, link_1]], J[R, color[Green], P[50.77500000000002, 24.79083850931677], L[link_2, link_3]], J[R, color[Green], P[74.375, 7.625], L[ground, link_3]], J[R, color[Green], P[11.88, 1.0], L[link_1, link_2]], J[R, color[Green], P[93.15260869565219, 56.412173913043475], L[link_2]]]",
    "Ball lifter (Double six linkage)":"M[J[R, color[Green], P[10.2, 10.4], L[ground, link_0]], J[R, color[Green], P[7.44, 20.01], L[link_0, link_1, link_5]], J[R, color[Green], P[-10.52, 11.21], L[link_1, link_2]], J[R, color[Green], P[-28.48, 2.42], L[link_1, link_3]], J[R, color[Green], P[-6.6, 0.0], L[ground, link_2]], J[R, color[Green], P[-12.8, 0.0], L[ground, link_4]], J[R, color[Green], P[-22.61, 12.64], L[link_3, link_4]], J[R, color[Green], P[-56.1, 6.78], L[link_3]], J[R, color[Green], P[43.78, 20.17], L[ground, link_6]], J[R, color[Green], P[15.02, 40.85], L[link_5, link_6]], J[R, color[Green], P[22.16, 60.5], L[link_5, link_7]], J[R, color[Green], P[23.8, 0.0], L[ground, link_8]], J[R, color[Green], P[35.64, 40.55], L[link_7, link_8]], J[R, color[Green], P[8.73, 80.39], L[link_7]]]",
    #"":"",
}
