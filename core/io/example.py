...
example_list = {
    ...
    "Crank slider":"M[J[R, color[Green], P[-26.625, 46.125], L[link_0, link_1]], J[RP, A[0.0], color[Green], P[16.88, -2.63], L[ground, link_0]], J[R, color[Green], P[-49.625, 4.125], L[ground, link_1]]]",
    #"":"",
}
