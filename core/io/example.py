...
example_list = {
    ...
    "Double four bar linkage":"M[J[R, color[Green], P[0.0, 0.0], L[ground, link_0]], J[R, color[Green], P[0.0, 10.0], L[link_0, link_1, link_3]], J[R, color[Green], P[10.0, 20.0], L[link_1, link_2]], J[R, color[Green], P[20.0, 30.0], L[link_1, link_7]], J[R, color[Green], P[20.0, 10.0], L[ground, link_2]], J[R, color[Green], P[-20.0, 10.0], L[ground, link_4]], J[R, color[Green], P[-10.0, 20.0], L[link_3, link_4]], J[R, color[Green], P[-20.0, 30.0], L[link_3, link_5]], J[R, color[Green], P[-40.0, 10.0], L[link_5, link_6]], J[R, color[Green], P[-50.0, 20.0], L[ground, link_6]], J[R, color[Green], P[40.0, 10.0], L[link_7, link_8]], J[R, color[Green], P[50.0, 20.0], L[ground, link_8]], J[R, color[Green], P[0.0, 50.0], L[link_7]], J[R, color[Green], P[0.0, 50.0], L[link_5]]]",
    #"":"",
}
