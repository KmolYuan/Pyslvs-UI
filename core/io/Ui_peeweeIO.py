...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.commit_search = QtWidgets.QPushButton(Form)
        self.commit_search.setObjectName("commit_search")
        self.horizontalLayout_3.addWidget(self.commit_search)
    ...
    def retranslateUi(self, Form):
        ...
        self.commit_search_text.setPlaceholderText(_translate("Form", "Enter a keyword about the commit description."))
        self.commit_search.setText(_translate("Form", "Search"))
