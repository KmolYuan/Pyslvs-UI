...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.path_edit = QLineEdit(Dialog)
        self.path_edit.setObjectName("path_edit")
        self.horizontalLayout_2.addWidget(self.path_edit)
        self.choose_dir_button = QToolButton(Dialog)
        icon = QIcon()
        icon.addPixmap(QPixmap(":/icons/loadfile.png"), QIcon.Normal, QIcon.Off)
        ...
        self.newfolder_option = QCheckBox(Dialog)
        ...
        self.assembly_radio = QRadioButton(self.output_group)
        ...
        self.assembly_group = QWidget(self.output_group)
        self.assembly_group.setObjectName("assembly_group")
        self.assembly_layout = QVBoxLayout(self.assembly_group)
        self.assembly_layout.setObjectName("assembly_layout")
        self.assembly_label = QLabel(self.assembly_group)
        ...
        self.link_radius_label = QLabel(self.assembly_group)
        ...
        self.link_radius = QDoubleSpinBox(self.assembly_group)
        ...
        self.frame_radio = QRadioButton(self.output_group)
        self.frame_radio.setObjectName("frame_radio")
        self.output_layout.addWidget(self.frame_radio)
        self.frame_group = QWidget(self.output_group)
        self.frame_group.setEnabled(False)
        self.frame_group.setObjectName("frame_group")
        self.verticalLayout = QVBoxLayout(self.frame_group)
        self.verticalLayout.setObjectName("verticalLayout")
        self.frame_label = QLabel(self.frame_group)
