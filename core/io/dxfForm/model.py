...
def dxfModel(file_name, Link, Chain, LinkWidth=8, ChainWidth=8, interval=2, drilling=6):
    ...
    for e in Chain:
        ...
        block = dxf.block(name=name)
        radius = ChainWidth/2
        alpha = degrees(acos((e['p1p2']**2+e['p1p3']**2-e['p2p3']**2)/(2*e['p1p2']*e['p1p3'])))
        beta = degrees(acos((e['p1p2']**2+e['p2p3']**2-e['p1p3']**2)/(2*e['p1p2']*e['p2p3'])))
        garma = degrees(acos((e['p2p3']**2+e['p1p3']**2-e['p1p2']**2)/(2*e['p2p3']*e['p1p3'])))
        p1 = (0, 0)
        p2 = (e['p1p2'], 0)
