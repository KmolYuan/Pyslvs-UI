...
def _binary_write(filename, faces):
    with open(filename, 'wb') as data:
        ...
        for verts in faces:
            ...
            verts = tuple(itertools.chain.from_iterable(verts))
            data.write(pad + struct.Struct('<{}f'.format(len(verts))).pack(*verts))
            data.write(b'\0\0')
            nb += 1
...
if __name__ == '__main__':
    data = read_stl("/home/ahshoe/Desktop/test.stl")
    write_stl("/home/ahshoe/Desktop/test_binary.stl", data)
    write_stl("/home/ahshoe/Desktop/test_ascii.stl", data, ascii=True)
    print(data)
    #print(read_stl("/home/ahshoe/Desktop/test_binary.stl"))
    print(read_stl("/home/ahshoe/Desktop/test_ascii.stl"))
