...
_slvs.SLVS_RESULT_OKAY_swigconstant(_slvs)
SLVS_RESULT_OKAY = _slvs.SLVS_RESULT_OKAY

_slvs.SLVS_RESULT_INCONSISTENT_swigconstant(_slvs)
SLVS_RESULT_INCONSISTENT = _slvs.SLVS_RESULT_INCONSISTENT

_slvs.SLVS_RESULT_DIDNT_CONVERGE_swigconstant(_slvs)
SLVS_RESULT_DIDNT_CONVERGE = _slvs.SLVS_RESULT_DIDNT_CONVERGE

_slvs.SLVS_RESULT_TOO_MANY_UNKNOWNS_swigconstant(_slvs)
