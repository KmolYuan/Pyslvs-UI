...
class Slvs_Param(_object):
    ...
    if _newclass:h = _swig_property(_slvs.Slvs_Param_h_get, _slvs.Slvs_Param_h_set)
    __swig_setmethods__["group"] = _slvs.Slvs_Param_group_set
    __swig_getmethods__["group"] = _slvs.Slvs_Param_group_get
    if _newclass:group = _swig_property(_slvs.Slvs_Param_group_get, _slvs.Slvs_Param_group_set)
    __swig_setmethods__["val"] = _slvs.Slvs_Param_val_set
    __swig_getmethods__["val"] = _slvs.Slvs_Param_val_get
    if _newclass:val = _swig_property(_slvs.Slvs_Param_val_get, _slvs.Slvs_Param_val_set)
    def __init__(self): 
...
class Slvs_Constraint(_object):
    ...
    if _newclass:entityA = _swig_property(_slvs.Slvs_Constraint_entityA_get, _slvs.Slvs_Constraint_entityA_set)
    ...
    if _newclass:entityB = _swig_property(_slvs.Slvs_Constraint_entityB_get, _slvs.Slvs_Constraint_entityB_set)
    ...
    if _newclass:entityC = _swig_property(_slvs.Slvs_Constraint_entityC_get, _slvs.Slvs_Constraint_entityC_set)
    ...
    if _newclass:entityD = _swig_property(_slvs.Slvs_Constraint_entityD_get, _slvs.Slvs_Constraint_entityD_set)
    __swig_setmethods__["other"] = _slvs.Slvs_Constraint_other_set
    __swig_getmethods__["other"] = _slvs.Slvs_Constraint_other_get
    if _newclass:other = _swig_property(_slvs.Slvs_Constraint_other_get, _slvs.Slvs_Constraint_other_set)
    __swig_setmethods__["other2"] = _slvs.Slvs_Constraint_other2_set
    __swig_getmethods__["other2"] = _slvs.Slvs_Constraint_other2_get
    if _newclass:other2 = _swig_property(_slvs.Slvs_Constraint_other2_get, _slvs.Slvs_Constraint_other2_set)
    def __init__(self): 
...
class Slvs_System(_object):
    ...
    if _newclass:params = _swig_property(_slvs.Slvs_System_params_get, _slvs.Slvs_System_params_set)
    __swig_setmethods__["entity"] = _slvs.Slvs_System_entity_set
    __swig_getmethods__["entity"] = _slvs.Slvs_System_entity_get
    if _newclass:entity = _swig_property(_slvs.Slvs_System_entity_get, _slvs.Slvs_System_entity_set)
    __swig_setmethods__["entities"] = _slvs.Slvs_System_entities_set
    __swig_getmethods__["entities"] = _slvs.Slvs_System_entities_get
    if _newclass:entities = _swig_property(_slvs.Slvs_System_entities_get, _slvs.Slvs_System_entities_set)
    ...
    if _newclass:constraint = _swig_property(_slvs.Slvs_System_constraint_get, _slvs.Slvs_System_constraint_set)
    ...
    if _newclass:constraints = _swig_property(_slvs.Slvs_System_constraints_get, _slvs.Slvs_System_constraints_set)
    __swig_setmethods__["dragged"] = _slvs.Slvs_System_dragged_set
    __swig_getmethods__["dragged"] = _slvs.Slvs_System_dragged_get
    if _newclass:dragged = _swig_property(_slvs.Slvs_System_dragged_get, _slvs.Slvs_System_dragged_set)
    ...
    if _newclass:calculateFaileds = _swig_property(_slvs.Slvs_System_calculateFaileds_get, _slvs.Slvs_System_calculateFaileds_set)
    __swig_setmethods__["failed"] = _slvs.Slvs_System_failed_set
    __swig_getmethods__["failed"] = _slvs.Slvs_System_failed_get
    if _newclass:failed = _swig_property(_slvs.Slvs_System_failed_get, _slvs.Slvs_System_failed_set)
    __swig_setmethods__["faileds"] = _slvs.Slvs_System_faileds_set
    __swig_getmethods__["faileds"] = _slvs.Slvs_System_faileds_get
    if _newclass:faileds = _swig_property(_slvs.Slvs_System_faileds_get, _slvs.Slvs_System_faileds_set)
    __swig_setmethods__["dof"] = _slvs.Slvs_System_dof_set
    __swig_getmethods__["dof"] = _slvs.Slvs_System_dof_get
    if _newclass:dof = _swig_property(_slvs.Slvs_System_dof_get, _slvs.Slvs_System_dof_set)
    __swig_setmethods__["result"] = _slvs.Slvs_System_result_set
    __swig_getmethods__["result"] = _slvs.Slvs_System_result_get
    if _newclass:result = _swig_property(_slvs.Slvs_System_result_get, _slvs.Slvs_System_result_set)
    def __init__(self): 
...
def Slvs_Solve(*args) -> "void" :
  return _slvs.Slvs_Solve(*args)
Slvs_Solve = _slvs.Slvs_Solve

def Slvs_QuaternionU(*args) -> "double *, double *, double *" :
  return _slvs.Slvs_QuaternionU(*args)
Slvs_QuaternionU = _slvs.Slvs_QuaternionU

def Slvs_QuaternionV(*args) -> "double *, double *, double *" :
  return _slvs.Slvs_QuaternionV(*args)
Slvs_QuaternionV = _slvs.Slvs_QuaternionV

def Slvs_QuaternionN(*args) -> "double *, double *, double *" :
  return _slvs.Slvs_QuaternionN(*args)
Slvs_QuaternionN = _slvs.Slvs_QuaternionN

def Slvs_MakeQuaternion(*args) -> "double *, double *, double *, double *" :
  return _slvs.Slvs_MakeQuaternion(*args)
Slvs_MakeQuaternion = _slvs.Slvs_MakeQuaternion

def Slvs_MakeParam(*args) -> "Slvs_Param" :
  return _slvs.Slvs_MakeParam(*args)
Slvs_MakeParam = _slvs.Slvs_MakeParam

def Slvs_MakePoint2d(*args) -> "Slvs_Entity" :
  return _slvs.Slvs_MakePoint2d(*args)
Slvs_MakePoint2d = _slvs.Slvs_MakePoint2d

def Slvs_MakePoint3d(*args) -> "Slvs_Entity" :
  return _slvs.Slvs_MakePoint3d(*args)
Slvs_MakePoint3d = _slvs.Slvs_MakePoint3d

def Slvs_MakeNormal3d(*args) -> "Slvs_Entity" :
  return _slvs.Slvs_MakeNormal3d(*args)
Slvs_MakeNormal3d = _slvs.Slvs_MakeNormal3d

def Slvs_MakeNormal2d(*args) -> "Slvs_Entity" :
  return _slvs.Slvs_MakeNormal2d(*args)
Slvs_MakeNormal2d = _slvs.Slvs_MakeNormal2d

def Slvs_MakeDistance(*args) -> "Slvs_Entity" :
  return _slvs.Slvs_MakeDistance(*args)
Slvs_MakeDistance = _slvs.Slvs_MakeDistance

def Slvs_MakeLineSegment(*args) -> "Slvs_Entity" :
  return _slvs.Slvs_MakeLineSegment(*args)
Slvs_MakeLineSegment = _slvs.Slvs_MakeLineSegment

def Slvs_MakeCubic(*args) -> "Slvs_Entity" :
  return _slvs.Slvs_MakeCubic(*args)
Slvs_MakeCubic = _slvs.Slvs_MakeCubic

def Slvs_MakeArcOfCircle(*args) -> "Slvs_Entity" :
  return _slvs.Slvs_MakeArcOfCircle(*args)
Slvs_MakeArcOfCircle = _slvs.Slvs_MakeArcOfCircle

def Slvs_MakeCircle(*args) -> "Slvs_Entity" :
  return _slvs.Slvs_MakeCircle(*args)
Slvs_MakeCircle = _slvs.Slvs_MakeCircle

def Slvs_MakeWorkplane(*args) -> "Slvs_Entity" :
  return _slvs.Slvs_MakeWorkplane(*args)
Slvs_MakeWorkplane = _slvs.Slvs_MakeWorkplane

def Slvs_MakeConstraint(*args) -> "Slvs_Constraint" :
  return _slvs.Slvs_MakeConstraint(*args)
...
class Param(_object):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args): 
        this = _slvs.new_Param(*args)
        try: self.this.append(this)
        except: self.this = this
    def GetHandle(self) -> "Slvs_hParam" : return _slvs.Param_GetHandle(self)
    def GetGroup(self) -> "Slvs_hGroup" : return _slvs.Param_GetGroup(self)
    def GetValue(self) -> "double" : return _slvs.Param_GetValue(self)
    def SetValue(self, *args) -> "void" : return _slvs.Param_SetValue(self, *args)
...
class Entity(_object):
    ...
    __repr__ = _swig_repr
    def GetHandle(self) -> "Slvs_hEntity" : return _slvs.Entity_GetHandle(self)
    def GetGroup(self) -> "Slvs_hGroup" : return _slvs.Entity_GetGroup(self)
    __swig_getmethods__["handle"] = GetHandle
    if _newclass: handle = property(GetHandle)
...
class Point3d(Point):
    ...
    def x(self) -> "Param" : return _slvs.Point3d_x(self)
    def y(self) -> "Param" : return _slvs.Point3d_y(self)
    def z(self) -> "Param" : return _slvs.Point3d_z(self)
    def to_openscad(self):
...
class Normal3d(Entity):
    ...
    def isNormalIn3D(self) -> "bool" : return _slvs.Normal3d_isNormalIn3D(self)
    def qw(self) -> "Param" : return _slvs.Normal3d_qw(self)
    def qx(self) -> "Param" : return _slvs.Normal3d_qx(self)
    def qy(self) -> "Param" : return _slvs.Normal3d_qy(self)
    def qz(self) -> "Param" : return _slvs.Normal3d_qz(self)
    def isNormalIn2D(self) -> "bool" : return _slvs.Normal3d_isNormalIn2D(self)
    def workplane(self) -> "Workplane" : return _slvs.Normal3d_workplane(self)
    def vector(self):
...
class Workplane(Entity):
    ...
    if _newclass:FreeIn3D = _swig_property(_slvs.Workplane_FreeIn3D_get, _slvs.Workplane_FreeIn3D_set)
    def __init__(self, *args): 
        this = _slvs.new_Workplane(*args)
        try: self.this.append(this)
        except: self.this = this
    def origin(self) -> "Point3d" : return _slvs.Workplane_origin(self)
    def normal(self) -> "Normal3d" : return _slvs.Workplane_normal(self)
...
class Point2d(Point):
    ...
    def u(self) -> "Param" : return _slvs.Point2d_u(self)
    def v(self) -> "Param" : return _slvs.Point2d_v(self)
    def workplane(self) -> "Workplane" : return _slvs.Point2d_workplane(self)
    def to_openscad(self):
...
class LineSegment3d(LineSegment):
    ...
    def a(self) -> "Point3d" : return _slvs.LineSegment3d_a(self)
    def b(self) -> "Point3d" : return _slvs.LineSegment3d_b(self)
...
class LineSegment2d(LineSegment):
    ...
    def a(self) -> "Point2d" : return _slvs.LineSegment2d_a(self)
    def b(self) -> "Point2d" : return _slvs.LineSegment2d_b(self)
    def workplane(self) -> "Workplane" : return _slvs.LineSegment2d_workplane(self)
...
class ArcOfCircle(Circular):
    __swig_setmethods__ = {}
    for _s in [Circular]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ArcOfCircle, name, value)
    __swig_getmethods__ = {}
    for _s in [Circular]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    ...
    def center(self) -> "Point2d" : return _slvs.ArcOfCircle_center(self)
    def start(self) -> "Point2d" : return _slvs.ArcOfCircle_start(self)
    def end(self) -> "Point2d" : return _slvs.ArcOfCircle_end(self)
    def normal(self) -> "Normal3d" : return _slvs.ArcOfCircle_normal(self)
    def workplane(self) -> "Workplane" : return _slvs.ArcOfCircle_workplane(self)
...
class Distance(Entity):
    ...
    def distance(self) -> "Param" : return _slvs.Distance_distance(self)
    def workplane(self) -> "Workplane" : return _slvs.Distance_workplane(self)
...
class Circle(Circular):
    ...
    def center(self) -> "Point2d" : return _slvs.Circle_center(self)
    def distance(self) -> "Distance" : return _slvs.Circle_distance(self)
    def normal(self) -> "Normal3d" : return _slvs.Circle_normal(self)
    def workplane(self) -> "Workplane" : return _slvs.Circle_workplane(self)
...
class Constraint(_object):
    ...
    def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    def GetHandle(self) -> "Slvs_hEntity" : return _slvs.Constraint_GetHandle(self)
    def system(self) -> "System *" : return _slvs.Constraint_system(self)
    def GetGroup(self) -> "Slvs_hGroup" : return _slvs.Constraint_GetGroup(self)
    def type(self) -> "int" : return _slvs.Constraint_type(self)
    __swig_getmethods__["handle"] = GetHandle
    if _newclass: handle = property(GetHandle)
    ...
    __swig_getmethods__["some_other_constraint"] = lambda x: _slvs.Constraint_some_other_constraint
    if _newclass:some_other_constraint = staticmethod(_slvs.Constraint_some_other_constraint)
    __swig_getmethods__["distance"] = lambda x: _slvs.Constraint_distance
    if _newclass:distance = staticmethod(_slvs.Constraint_distance)
    __swig_getmethods__["on"] = lambda x: _slvs.Constraint_on
    if _newclass:on = staticmethod(_slvs.Constraint_on)
    __swig_getmethods__["horizontal"] = lambda x: _slvs.Constraint_horizontal
    if _newclass:horizontal = staticmethod(_slvs.Constraint_horizontal)
    __swig_getmethods__["vertical"] = lambda x: _slvs.Constraint_vertical
    if _newclass:vertical = staticmethod(_slvs.Constraint_vertical)
    __swig_getmethods__["diameter"] = lambda x: _slvs.Constraint_diameter
    if _newclass:diameter = staticmethod(_slvs.Constraint_diameter)
    __swig_getmethods__["equal_radius"] = lambda x: _slvs.Constraint_equal_radius
    if _newclass:equal_radius = staticmethod(_slvs.Constraint_equal_radius)
    __swig_getmethods__["equal"] = lambda x: _slvs.Constraint_equal
    if _newclass:equal = staticmethod(_slvs.Constraint_equal)
    __swig_getmethods__["equal_point_line"] = lambda x: _slvs.Constraint_equal_point_line
    if _newclass:equal_point_line = staticmethod(_slvs.Constraint_equal_point_line)
    __swig_getmethods__["equal_angle"] = lambda x: _slvs.Constraint_equal_angle
    if _newclass:equal_angle = staticmethod(_slvs.Constraint_equal_angle)
    __swig_getmethods__["ratio"] = lambda x: _slvs.Constraint_ratio
    if _newclass:ratio = staticmethod(_slvs.Constraint_ratio)
    __swig_getmethods__["symmetric"] = lambda x: _slvs.Constraint_symmetric
    if _newclass:symmetric = staticmethod(_slvs.Constraint_symmetric)
    __swig_getmethods__["symmetric_H"] = lambda x: _slvs.Constraint_symmetric_H
    if _newclass:symmetric_H = staticmethod(_slvs.Constraint_symmetric_H)
    __swig_getmethods__["symmetric_V"] = lambda x: _slvs.Constraint_symmetric_V
    if _newclass:symmetric_V = staticmethod(_slvs.Constraint_symmetric_V)
    __swig_getmethods__["midpoint"] = lambda x: _slvs.Constraint_midpoint
    if _newclass:midpoint = staticmethod(_slvs.Constraint_midpoint)
    __swig_getmethods__["orientation"] = lambda x: _slvs.Constraint_orientation
    if _newclass:orientation = staticmethod(_slvs.Constraint_orientation)
    __swig_getmethods__["angle"] = lambda x: _slvs.Constraint_angle
    if _newclass:angle = staticmethod(_slvs.Constraint_angle)
    __swig_getmethods__["perpendicular"] = lambda x: _slvs.Constraint_perpendicular
    if _newclass:perpendicular = staticmethod(_slvs.Constraint_perpendicular)
    __swig_getmethods__["parallel"] = lambda x: _slvs.Constraint_parallel
    if _newclass:parallel = staticmethod(_slvs.Constraint_parallel)
    __swig_getmethods__["distance_proj"] = lambda x: _slvs.Constraint_distance_proj
    if _newclass:distance_proj = staticmethod(_slvs.Constraint_distance_proj)
    __swig_getmethods__["dragged"] = lambda x: _slvs.Constraint_dragged
    if _newclass:dragged = staticmethod(_slvs.Constraint_dragged)
    __swig_getmethods__["tangent"] = lambda x: _slvs.Constraint_tangent
    if _newclass:tangent = staticmethod(_slvs.Constraint_tangent)
...
class System(Slvs_System):
    __swig_setmethods__ = {}
    for _s in [Slvs_System]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, System, name, value)
    __swig_getmethods__ = {}
    for _s in [Slvs_System]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    ...
    if _newclass:default_group = _swig_property(_slvs.System_default_group_get, _slvs.System_default_group_set)
    def add_param(self, *args) -> "Param" : return _slvs.System_add_param(self, *args)
    def add_entity(self, *args) -> "void" : return _slvs.System_add_entity(self, *args)
    def add_entity_with_next_handle(self, *args) -> "Entity" : return _slvs.System_add_entity_with_next_handle(self, *args)
    def add_constraint(self, *args) -> "void" : return _slvs.System_add_constraint(self, *args)
    def get_param(self, *args) -> "Slvs_Param *" : return _slvs.System_get_param(self, *args)
    def set_dragged(self, *args) -> "void" : return _slvs.System_set_dragged(self, *args)
    __swig_setmethods__["dragged"] = set_dragged
    if _newclass: value = property(None, set_dragged)

    def solve(self, hg : 'Slvs_hGroup'=0) -> "int" : return _slvs.System_solve(self, hg)
    def add_point2d(self, *args) -> "Point2d" : return _slvs.System_add_point2d(self, *args)
    def add_point3d(self, *args) -> "Point3d" : return _slvs.System_add_point3d(self, *args)
    def entity_type(self, *args) -> "int" : return _slvs.System_entity_type(self, *args)
    def get_Point2d(self, *args) -> "Point2d" : return _slvs.System_get_Point2d(self, *args)
    def get_Point3d(self, *args) -> "Point3d" : return _slvs.System_get_Point3d(self, *args)
    def get_LineSegment2d(self, *args) -> "LineSegment2d" : return _slvs.System_get_LineSegment2d(self, *args)
    def get_LineSegment3d(self, *args) -> "LineSegment3d" : return _slvs.System_get_LineSegment3d(self, *args)
    def get_Normal3d(self, *args) -> "Normal3d" : return _slvs.System_get_Normal3d(self, *args)
    def get_Distance(self, *args) -> "Distance" : return _slvs.System_get_Distance(self, *args)
    def get_Workplane(self, *args) -> "Workplane" : return _slvs.System_get_Workplane(self, *args)
    def get_Cubic(self, *args) -> "Cubic" : return _slvs.System_get_Cubic(self, *args)
    def get_Circle(self, *args) -> "Circle" : return _slvs.System_get_Circle(self, *args)
    def get_ArcOfCircle(self, *args) -> "ArcOfCircle" : return _slvs.System_get_ArcOfCircle(self, *args)
