...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.zoom_cus_button.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.grid_mode_button.sizePolicy().hasHeightForWidth())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.zoom_cus_button.setStatusTip(_translate("MainWindow", "Customize zooming."))
        self.zoom_bar.setStatusTip(_translate("MainWindow", "Adjust the slider to change demo size."))
        self.zoom_button.setStatusTip(_translate("MainWindow", "Show zooming settings."))
        self.reset_canvas_button.setStatusTip(_translate("MainWindow", "Zoom to fit."))
        self.grid_mode_button.setStatusTip(_translate("MainWindow", "Grid mode: Snap the mouse when dragging."))
