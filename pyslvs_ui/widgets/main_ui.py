...
"}")
        ...
        self.reset_canvas_button = QtWidgets.QPushButton(self.BrowserWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.reset_canvas_button.setIcon(icon13)
        self.reset_canvas_button.setIconSize(QtCore.QSize(32, 32))
        self.reset_canvas_button.setObjectName("reset_canvas_button")
        self.horizontalLayout_7.addWidget(self.reset_canvas_button)
        self.alignment_button = QtWidgets.QToolButton(self.BrowserWidget)
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/icons/vertical_align.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.alignment_button.setIcon(icon14)
        ...
        self.horizontalLayout_7.addWidget(self.alignment_button)
        ...
        self.menu_bar.setGeometry(QtCore.QRect(0, 0, 828, 21))
