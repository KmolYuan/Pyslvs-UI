...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.cp_data_btn = QtWidgets.QPushButton(self.analysis_tab)
        self.cp_data_btn.setIcon(icon9)
        self.cp_data_btn.setObjectName("cp_data_btn")
        self.horizontalLayout_9.addWidget(self.cp_data_btn)
        self.plot_btn = QtWidgets.QPushButton(self.analysis_tab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.horizontalLayout_9.addWidget(self.plot_btn)
        self.animate_btn = QtWidgets.QPushButton(self.analysis_tab)
        self.animate_btn.setIcon(icon)
        self.animate_btn.setObjectName("animate_btn")
        self.horizontalLayout_9.addWidget(self.animate_btn)
