...
class YamlEditor(FormatEditor):
    ...
    def save(self, file_name: str) -> None:
        ...
        yaml_script = yaml.safe_dump(data, default_flow_style=flow_style)
        if self.prefer.file_type_option == 1:
            yaml_script = sub(r"\s{2,}", " ", yaml_script)
    ...
    def load(self, file_name: str) -> None:
        ...
        with open(file_name, 'r', encoding='utf-8') as f:
            yaml_script = f.read()
        self.load_data(file_name, yaml.load(yaml_script, Loader=yaml.FullLoader))
