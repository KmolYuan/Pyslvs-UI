...
Download and build [PyQt5] and [PyQtChart].

In Python 3.5 or later, the environment that generated by `virtualenv --no-site-packages` can use pip directly:
...
Install PyQt5 and PyQtChart by pip.

```bash
> pip install -U pyqt5 pyqtchart
```
